...
describe('Clear Smog', () => {
  ...
  it('should remove all stat boosts from the target', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Amoonguss', ability: 'regenerator', moves: ['clearsmog'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Sableye', ability: 'prankster', moves: ['calmmind'] }],
    });
  ...
  it('should not remove stat boosts from a target behind a substitute', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Amoonguss', ability: 'regenerator', moves: ['clearsmog', 'toxic'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Sableye', ability: 'prankster', moves: ['substitute', 'calmmind'] }],
    });
  ...
  it('should not remove stat boosts if the target is immune to its attack type', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Steelix', ability: 'prankster', moves: ['irondefense'] }],
    });
  ...
  it('should not remove stat boosts from the user', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Arcanine', ability: 'intimidate', moves: ['morningsun'] }],
    });
      ...
      team: [
        {
          ...
          ability: 'regenerator',
          item: 'scopelens',
          moves: ['focusenergy', 'clearsmog'],
        },
      ],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Primeape', ability: 'angerpoint', moves: ['bulkup'] }],
    });
