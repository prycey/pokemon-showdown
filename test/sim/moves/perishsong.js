...
describe('Perish Song', () => {
  ...
  it(`should not affect other Pokemon with the ability Soundproof`, () => {
    ...
    assert(
      ...
      'Weavile should have been affected by its own Perish Song'
    );
    assert.false(
      battle.p2.active[0].volatiles['perishsong'],
      'Slowpoke should not have been affected by Perish Song'
    );
  });
  ...
  it(`should not affect any Pokemon with the ability Soundproof in Gen 7`, () => {
    ...
    assert.false(
      battle.p1.active[0].volatiles['perishsong'],
      'Weavile should not have been affected by Perish Song'
    );
    assert.false(
      battle.p2.active[0].volatiles['perishsong'],
      'Slowpoke should not have been affected by Perish Song'
