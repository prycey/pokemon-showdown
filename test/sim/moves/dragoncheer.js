...
describe('Dragon Cheer', () => {
  ...
  it('should raise critical hit ratio by 2 stages for dragon types', () => {
    ...
    battle.onEvent('ModifyCritRatio', battle.format, -99, critRatio => assert.equal(critRatio, 3));
  ...
  it('should raise critical hit ratio by 1 stage for non-dragon types', () => {
    ...
    battle.onEvent('ModifyCritRatio', battle.format, -99, critRatio => assert.equal(critRatio, 2));
