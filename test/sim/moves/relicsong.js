...
describe('Relic Song', () => {
  ...
  it('should transform Meloetta into its Pirouette forme', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Meloetta', ability: 'serenegrace', moves: ['relicsong'] }],
    });
    battle.setPlayer('p2', {
  ...
  it('should transform Meloetta-Pirouette into its Aria forme', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Meloetta-Pirouette', ability: 'serenegrace', moves: ['relicsong'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Registeel', ability: 'clearbody', moves: ['rest'] }],
    });
