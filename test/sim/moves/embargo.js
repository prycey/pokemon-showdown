...
describe('Embargo', () => {
  ...
  it('should negate residual healing events', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Lopunny', ability: 'limber', item: 'leftovers', moves: ['bellydrum'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Giratina', ability: 'pressure', moves: ['embargo'] }],
    });
  ...
  it('should prevent items from being consumed', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Lopunny', ability: 'limber', item: 'chopleberry', moves: ['bulkup'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Golem', ability: 'noguard', moves: ['embargo', 'lowkick'] }],
    });
  ...
  it('should ignore the effects of items that disable moves', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Lopunny', ability: 'limber', item: 'assaultvest', moves: ['protect'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Golem', ability: 'noguard', moves: ['embargo'] }],
    });
  ...
  it('should cause Fling to fail', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Lopunny', ability: 'limber', item: 'seaincense', moves: ['fling'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Sableye', ability: 'prankster', moves: ['embargo'] }],
    });
  ...
  it('should not prevent Pokemon from Mega Evolving', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Lopunny', ability: 'limber', item: 'lopunnite', moves: ['bulkup'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Golem', ability: 'noguard', moves: ['embargo', 'rest'] }],
    });
    battle.makeChoices('move bulkup', 'move embargo');
