...
describe(`Photon Geyser`, () => {
  ...
  it(`should become physical when Attack stat is higher than Special Attack stat`, () => {
    ...
    assert.statStage(
      ...
      'def',
      1,
      `physical Photon Geyser should trigger Kee Berry`
    );
    assert.false.fullHP(
      battle.p1.active[0],
      `physical Photon Geyser should be susceptible to Counter`
    );
  });
  ...
  it(`should always be a special Max Move, never physical`, () => {
    ...
    assert.statStage(
      ...
      'spd',
      1,
      `Photon Geyser behaved as a physical Max move, when it shouldn't`
    );
  });
  ...
  it(`should always be a special Z-move, never physical`, () => {
    ...
    assert.statStage(
      ...
      'spd',
      1,
      `Photon Geyser behaved as a physical Z-move, when it shouldn't`
    );
  });
  ...
  it(`should ignore abilities the same way as Mold Breaker`, () => {
    ...
    assert.false.fullHP(
      battle.p2.active[0],
      `Electrified Photon Geyser should damage through Volt Absorb`
    );
  });
      ...
      [
        {
          species: 'Liepard',
          ability: 'prankster',
          moves: ['assist', 'copycat', 'sleeptalk', 'photongeyser'],
        },
        { species: 'Necrozma', moves: ['photongeyser'] },
      ],
