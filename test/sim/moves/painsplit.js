...
describe('Pain Split', () => {
  ...
  it('should reduce the HP of the target to the average of the user and target', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Shedinja', ability: 'wonderguard', moves: ['painsplit'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Arceus', ability: 'multitype', moves: ['judgment'] }],
    });
  ...
  it('should calculate HP changes against a dynamaxed target properly', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Drifblim', ability: 'unburden', moves: ['painsplit'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Blissey', ability: 'serenegrace', moves: ['doubleedge'] }],
    });
