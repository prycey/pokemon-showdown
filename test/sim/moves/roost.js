...
describe('Roost', () => {
  ...
  it('should fail if the user is at max HP', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Clefable', item: 'leftovers', ability: 'unaware', moves: ['calmmind'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should heal the user', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Clefable', ability: 'unaware', moves: ['calmmind', 'hiddenpowergrass'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Dragonite', ability: 'multiscale', moves: ['roost', 'dragondance'] }],
    });
      ...
      team: [
        {
          ...
          item: 'leftovers',
          ability: 'sturdy',
          moves: ['mudslap', 'hiddenpowergrass'],
        },
      ],
    });
    battle.setPlayer('p2', {
  ...
  it('should treat a pure Flying pokémon as Normal type', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Tornadus', item: 'focussash', ability: 'prankster', moves: ['roost'] }],
    });
    battle.setPlayer('p2', {
      team: [
        {
