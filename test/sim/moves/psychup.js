      ...
      team: [
        {
          species: 'Palkia',
          level: 100,
          moves: ['sleeptalk', 'focusenergy', 'psychup', 'laserfocus'],
        },
...
describe('Psych Up [Gen 5]', () => {
  ...
  it("should not copy the opponent's crit ratio", () => {
    ...
    assert(
      !palkia.volatiles['focusenergy'],
      'A pokemon should not gain a Focus Energy boost when using Psych Up.'
    );
    ...
    assert(
      palkia.volatiles['focusenergy'],
      'A pokemon should not lose a Focus Energy boost when using Psych Up.'
    );
  });
});
