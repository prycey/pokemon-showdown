...
describe('Knock Off', () => {
  ...
  it('should remove most items', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Mew', ability: 'synchronize', moves: ['knockoff'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should not remove items when hitting Sub', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Mew', ability: 'noability', moves: ['knockoff'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should not remove items if the user faints mid-move', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Shedinja', ability: 'wonderguard', moves: ['knockoff'] }],
    });
    battle.setPlayer('p2', {
      team: [
