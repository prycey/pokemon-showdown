...
describe('Belly Drum', () => {
  ...
  it("should reduce the user's HP by half of their maximum HP, then boost their Attack to maximum", () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Linoone', ability: 'limber', moves: ['bellydrum'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Terrakion', ability: 'justified', moves: ['bulkup'] }],
    });
  ...
  it("should fail if the user's HP is less than half of their maximum HP", () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Linoone', ability: 'sturdy', moves: ['bellydrum'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Terrakion', ability: 'justified', moves: ['closecombat'] }],
    });
    const user = battle.p1.active[0];
...
describe('Z-Belly Drum', () => {
  ...
  it("should heal the user, then reduce their HP by half their max HP and boost the user's Attack to maximum", () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Linoone', ability: 'limber', item: 'normaliumz', moves: ['bellydrum'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Rattata', ability: 'guts', moves: ['quickattack'] }],
    });
    const user = battle.p1.active[0];
  ...
  it("should not fail even if the user's HP is less than half of their maximum HP", () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Linoone', ability: 'sturdy', item: 'normaliumz', moves: ['bellydrum'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Terrakion', ability: 'justified', moves: ['closecombat'] }],
    });
