...
describe(`Me First`, () => {
  ...
  it(`should be selectable even if the user is Taunted or holds Assault Vest`, () => {
  ...
  it(`should not copy recharge turns from moves like Hyper Beam`, () => {
    battle = common
      .gen(7)
      .createBattle([
    ...
    assert.equal(
      rechargeIndex,
      -1,
      'Aerodactyl should fail to copy a recharge turn, not recharge itself.'
    );
  });
});
