...
describe('Ingrain', () => {
  ...
  it('should heal the user by 1/16 of its max HP at the end of each turn', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Miltank', ability: 'thickfat', moves: ['seismictoss', 'protect'] }],
    });
  ...
  it('should prevent the user from being forced out or switching out', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Arcanine', ability: 'flashfire', moves: ['sleeptalk', 'roar'] }],
    });
  ...
  it("should remove the users' Ground immunities", () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Tropius', ability: 'harvest', moves: ['earthquake', 'ingrain'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Carnivine', ability: 'levitate', moves: ['earthquake', 'ingrain'] }],
    });
