...
describe('Misty Terrain', () => {
  ...
  it('should change the current terrain to Misty Terrain for five turns', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Florges', ability: 'symbiosis', moves: ['mist', 'mistyterrain'] }],
    });
    battle.setPlayer('p2', {
  ...
  it('should halve the base power of Dragon-type attacks on grounded Pokemon', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Shaymin', ability: 'naturalcure', moves: ['mistyterrain'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Shaymin-Sky', ability: 'serenegrace', moves: ['leechseed'] }],
    });
  ...
  it('should prevent moves from setting non-volatile status on grounded Pokemon', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Florges', ability: 'symbiosis', moves: ['mistyterrain', 'toxic'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should not remove active non-volatile statuses from grounded Pokemon', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Florges', ability: 'symbiosis', moves: ['mistyterrain'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Crobat', ability: 'infiltrator', moves: ['toxic'] }],
    });
  ...
  it('should prevent Yawn from putting grounded Pokemon to sleep, but not cause Yawn to fail', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Florges', ability: 'symbiosis', moves: ['mistyterrain', 'yawn'] }],
    });
    battle.setPlayer('p2', {
  ...
  it('should cause Rest to fail on grounded Pokemon', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Florges', ability: 'symbiosis', moves: ['mistyterrain', 'rest'] }],
    });
    battle.setPlayer('p2', {
  ...
  it('should not affect Pokemon in a semi-invulnerable state', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Sableye', ability: 'prankster', moves: ['yawn', 'mistyterrain'] }],
    });
    battle.makeChoices('move yawn', 'move yawn');
  ...
  it('should cause Nature Power to become Moonblast', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Whimsicott', ability: 'prankster', moves: ['mistyterrain'] }],
    });
    battle.setPlayer('p2', {
