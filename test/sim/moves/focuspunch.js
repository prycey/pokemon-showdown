...
describe('Focus Punch', () => {
  ...
  it(`should display a message indicating the Pokemon is tightening focus`, () => {
    ...
    battle.makeChoices();
    const tighteningFocusMessage = battle.log.indexOf(
      '|-singleturn|p1a: Chansey|move: Focus Punch'
    );
  ...
  it(`should tighten focus after switches in Gen 5+`, () => {
    ...
    assert(
      focusPunchChargeIndex > switchIndex,
  ...
  it(`should tighten focus before switches in Gens 3-4`, () => {
    ...
    assert(
      focusPunchChargeIndex < switchIndex,
      `Focus Punch's charge message should occur before switches in Gens 3-4`
    );
  });
});
