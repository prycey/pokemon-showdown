...
describe('Foresight', () => {
  ...
  it('should negate Normal and Fighting immunities', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Dusknoir', ability: 'prankster', moves: ['recover'] }],
    });
  ...
  it('should ignore the effect of positive evasion stat stages', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Smeargle', ability: 'owntempo', moves: ['avalanche', 'foresight'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Forretress', ability: 'sturdy', moves: ['synthesis'] }],
    });
      ...
      team: [
        {
          species: 'Smeargle',
          ability: 'owntempo',
          moves: ['zapcannon', 'dynamicpunch', 'foresight'],
        },
      ],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Zapdos', ability: 'owntempo', moves: ['roost'] }],
    });
