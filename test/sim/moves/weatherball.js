...
describe('Weather Ball', () => {
  ...
  it('should change type when used as a Z-move in weather', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Castform', item: 'normaliumz', moves: ['weatherball'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should not trigger counter when it is special during gen 3', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Shuckle', ability: 'drizzle', moves: ['weatherball'] }],
    });
  ...
  it('should trigger mirror coat when it is special during gen 3', () => {
    battle = common.gen(3).createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Shuckle', ability: 'drought', moves: ['weatherball'] }],
    });
  ...
  it('should trigger counter when it is physical during gen 3', () => {
    battle = common.gen(3).createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Shuckle', ability: 'sandstream', moves: ['weatherball'] }],
    });
    battle.setPlayer('p2', { team: [{ species: 'Shuckle', moves: ['counter'] }] });
    battle.makeChoices();
    assert.false.fullHP(battle.p1.active[0]);
