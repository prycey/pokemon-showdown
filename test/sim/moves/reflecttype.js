...
describe('Reflect Type', () => {
  ...
  it('should fail when used against a Pokemon whose type is "???"', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Arcanine', ability: 'intimidate', moves: ['burnup'] }],
    });
    battle.setPlayer('p2', {
      team: [
    ...
    assert.constant(
      () => battle.p2.active[0].getTypes(),
      () => battle.makeChoices('move burnup', 'move reflecttype')
    );
  });
      ...
      team: [
        {
          ...
          ability: 'levitate',
          item: 'laggingtail',
          moves: ['reflecttype', 'trickortreat'],
        },
      ],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Moltres', ability: 'pressure', moves: ['burnup'] }],
    });
