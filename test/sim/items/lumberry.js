...
describe('Lum Berry', () => {
  ...
  it('should heal a non-volatile status condition', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Machamp', ability: 'noguard', item: 'lumberry', moves: ['sleeptalk'] }],
    });
  ...
  it('should cure confusion', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Golurk', ability: 'noguard', moves: ['dynamicpunch'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Shuckle', item: 'lumberry', moves: ['sleeptalk'] }],
    });
  ...
  it('should be eaten immediately when the holder gains a status condition', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Charizard', item: 'lumberry', moves: ['outrage'] }],
    });
