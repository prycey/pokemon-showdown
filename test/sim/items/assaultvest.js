...
describe('Assault Vest', () => {
  ...
  it('should disable the use of Status moves', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Abra', ability: 'synchronize', moves: ['teleport'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Abra', ability: 'synchronize', item: 'assaultvest', moves: ['teleport'] }],
    });
  ...
  it('should not prevent the use of Status moves', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Lopunny', ability: 'klutz', item: 'assaultvest', moves: ['trick'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Abra', ability: 'synchronize', item: 'ironball', moves: ['calmmind'] }],
    });
