...
describe('Metronome (item)', () => {
  ...
  it(`should instantly start moves that use a charging turn at Metronome 1 boost level, then increase linearly`, () => {
    ...
    let possibleDamageRolls = [
      290, 294, 296, 300, 304, 307, 311, 314, 318, 320, 324, 328, 331, 335, 338, 342,
    ];
    ...
    possibleDamageRolls = [
      339, 343, 346, 350, 354, 358, 363, 367, 371, 374, 378, 382, 386, 391, 395, 399,
    ];
