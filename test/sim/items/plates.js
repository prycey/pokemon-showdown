  ...
  for (const plate of plates) {
    describe(plate, () => {
      ...
      it('should not be stolen or removed if held by an Arceus', () => {
        ...
        battle.setPlayer('p1', {
          team: [{ species: 'Arceus', ability: 'frisk', item: id, moves: ['recover'] }],
        });
        battle.setPlayer('p2', {
          team: [
      ...
      it('should not be removed by Fling if held by an Arceus', () => {
        battle = common.createBattle();
        battle.setPlayer('p1', {
          team: [{ species: 'Mawile', ability: 'intimidate', moves: ['swordsdance'] }],
        });
        battle.setPlayer('p2', {
          team: [{ species: 'Arceus', ability: 'frisk', item: id, moves: ['fling'] }],
        });
      ...
      it('should not be given to an Arceus', () => {
        battle = common.createBattle();
        battle.setPlayer('p1', {
          team: [{ species: 'Arceus', ability: 'multitype', moves: ['thief'] }],
        });
        battle.setPlayer('p2', {
          team: [{ species: 'Azumarill', ability: 'thickfat', item: id, moves: ['bestow'] }],
        });
      ...
      it('should be removed if not held by an Arceus', () => {
        battle = common.createBattle();
        battle.setPlayer('p1', {
          team: [{ species: 'Arceus', ability: 'multitype', moves: ['knockoff'] }],
        });
        battle.setPlayer('p2', {
          team: [{ species: 'Azumarill', ability: 'thickfat', item: id, moves: ['bulkup'] }],
        });
