...
describe('Mirror Herb', () => {
  ...
  it("should copy all 'simultaneous' boosts from multiple opponents", () => {
      ...
      [
        {
          ...
          moves: ['sleeptalk', 'haze'],
        },
        {
          species: 'Annihilape',
          ability: 'Defiant',
          item: 'Weakness Policy',
          moves: ['sleeptalk', 'howl'],
        },
      ],
    ]);
    ...
    assert.statStage(
      ...
      'atk',
      4,
      `Mirror Herb should have copied both Defiant boosts but only boosted atk by ${electrode.boosts.atk}`
    );
    ...
    assert.statStage(
      ...
      'atk',
      2,
      `Mirror Herb should have copied both Howl boosts but only boosted atk by ${electrode.boosts.atk}`
    );
    ...
    assert.statStage(
      ...
      'spa',
      4,
      `Mirror Herb should have copied all Weakness Policy boosts but only boosted spa by ${electrode.boosts.spa}`
    );
  });
