  ...
  for (const drive of drives) {
    describe(drive, () => {
      ...
      it('should not be stolen or removed if held by a Genesect', () => {
        ...
        battle.setPlayer('p1', {
          team: [{ species: 'Genesect', ability: 'frisk', item: id, moves: ['recover'] }],
        });
        battle.setPlayer('p2', {
          team: [
      ...
      it('should not be removed by Fling if held by a Genesect', () => {
        ...
        battle.setPlayer('p2', {
          team: [{ species: 'Genesect', ability: 'frisk', item: id, moves: ['fling'] }],
        });
      ...
      it('should not be given to a Genesect', () => {
        battle = common.createBattle();
        battle.setPlayer('p1', {
          team: [{ species: 'Genesect', ability: 'frisk', moves: ['thief'] }],
        });
        battle.setPlayer('p2', {
      ...
      it('should be removed if not held by a Genesect', () => {
        battle = common.createBattle();
        battle.setPlayer('p1', {
          team: [{ species: 'Genesect', ability: 'frisk', moves: ['knockoff'] }],
        });
        battle.setPlayer('p2', {
