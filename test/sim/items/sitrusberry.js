...
describe('Sitrus Berry', () => {
  ...
  it('should heal 25% hp when consumed', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Aggron', ability: 'sturdy', item: 'sitrusberry', moves: ['sleeptalk'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Lucario', ability: 'adaptability', moves: ['aurasphere'] }],
    });
  ...
  it.skip(`should heal 25% HP immediately after any end-of-turn effect`, () => {
    ...
    assert.species(
      darm,
      'Darmanitan',
      `Sitrus Berry should heal Darmanitan outside of Zen Mode range.`
    );
  });
});
