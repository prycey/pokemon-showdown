...
describe('Team Validator', () => {
  ...
  it('should reject non-existent Pokemon', () => {
    const team = [{ species: 'nonexistentPokemon', moves: ['thunderbolt'], evs: { hp: 1 } }];
    ...
    const team = [
      {
        ...
        ability: 'static',
        moves: ['thunderbolt'],
        happiness: 'invalidHappinessValue',
        evs: { hp: 1 },
      },
    ];
    assert.false.legalTeam(team, 'gen7customgame');
    ...
    const team = [
      {
        species: 'pikachu',
        ability: 'static',
        moves: ['blastburn', 'frenzyplant', 'hydrocannon', 'dragonascent'],
        evs: { hp: 1 },
      },
    ];
  ...
  it('should reject banned Pokemon', () => {
    ...
    team = [{ species: 'torkoal', ability: 'drought', moves: ['bodyslam'], evs: { hp: 1 } }];
    ...
    let team = [
      {
        ...
        item: 'gyaradosite',
        ability: 'intimidate',
        moves: ['dragondance', 'crunch', 'waterfall', 'icefang'],
        evs: { hp: 1 },
      },
      {
  ...
  it('should accept VC moves only with Hidden ability and correct IVs', () => {
    let team = [{ species: 'machamp', ability: 'steadfast', moves: ['fissure'], evs: { hp: 1 } }];
    assert.legalTeam(team, 'gen7anythinggoes');
    team = [{ species: 'tauros', ability: 'sheerforce', moves: ['bodyslam'], evs: { hp: 1 } }];
    assert.legalTeam(team, 'gen7anythinggoes');
    team = [
      {
        species: 'tauros',
    ...
    team = [{ species: 'machamp', ability: 'noguard', moves: ['fissure'], evs: { hp: 1 } }];
    assert.false.legalTeam(team, 'gen7anythinggoes');
    team = [
      {
        species: 'tauros',
    ...
    team = [{ species: 'koffing', ability: 'levitate', moves: ['zapcannon'], evs: { hp: 1 } }];
  ...
  it(`should disallow past gen only moves in Gen 9`, () => {
    const team = [{ species: 'oricorio', ability: 'dancer', moves: ['roleplay'], evs: { hp: 1 } }];
