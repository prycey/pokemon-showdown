...
describe('Team Validator', () => {
    ...
    team = [
      {
        species: 'shedinja',
        ability: 'wonderguard',
        moves: ['silverwind', 'swordsdance', 'batonpass'],
        evs: { hp: 1 },
      },
      {
        species: 'charmander',
        ability: 'blaze',
        moves: ['flareblitz', 'dragondance'],
        evs: { hp: 1 },
      },
    ];
  ...
  it('should correctly enforce per-game evolution restrictions', () => {
    ...
    team = [{ species: 'exeggutoralola', ability: 'frisk', moves: ['psybeam'], evs: { hp: 1 } }];
    assert.false.legalTeam(team, 'gen8anythinggoes');

    // This works in Gen 9+ because of Mirror Herb
    team = [{ species: 'raichualola', ability: 'surgesurfer', moves: ['fakeout'], evs: { hp: 1 } }];
  ...
  it('should enforce Gen 1 minimum levels', () => {
    let team = [{ species: 'onix', level: 12, moves: ['headbutt'] }];
  ...
  it('should prevent Pokemon from having a Gen 3 tutor move and a Gen 4 ability together without evolving', () => {
    ...
    team = [{ species: 'clefable', ability: 'magicguard', moves: ['softboiled'], evs: { hp: 1 } }];
    assert.legalTeam(team, 'gen4ou');
  });
    ...
    const team = [
      {
        ...
        moves: ['aircutter'],
        evs: { hp: 1 },
        ivs: { hp: 21, atk: 31, def: 21, spa: 21, spd: 31, spe: 0 },
      },
    ];
    ...
    team = [
      {
        species: 'incineroar',
        ability: 'blaze',
        moves: ['knockoff', 'partingshot'],
        evs: { hp: 1 },
      },
      {
        species: 'shelloseast',
        ability: 'stickyhold',
        moves: ['infestation', 'stringshot'],
        evs: { hp: 1 },
      },
    ];
