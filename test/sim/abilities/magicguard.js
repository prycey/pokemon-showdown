...
describe('Magic Guard', () => {
    ...
    battle = common.createBattle([
      [
        { species: 'Magikarp', ability: 'swiftswim', moves: ['splash'] },
        {
          ...
          ability: 'magicguard',
          item: 'lifeorb',
          moves: ['doubleedge', 'mindblown', 'highjumpkick'],
        },
      ],
      [
        {
          species: 'Crobat',
          ability: 'roughskin',
          moves: ['luckychant', 'spikes', 'toxic', 'protect'],
        },
      ],
    ]);
  ...
  it(`should prevent Leech Seed's healing effect`, () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Clefable', ability: 'magicguard', moves: ['moonblast'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Ferrothorn', ability: 'noguard', moves: ['leechseed'] }],
    });
  ...
  it('should not be suppressed by Mold Breaker', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Haxorus', ability: 'moldbreaker', moves: ['stealthrock', 'roar'] }],
    });
