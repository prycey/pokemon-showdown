...
describe('Delta Stream', () => {
  ...
  it('should activate the Delta Stream weather upon switch-in', () => {
  ...
  it('should negate the type weaknesses of the Flying-type', () => {
    battle = common.createBattle([
      ...
      [
        {
          species: 'Smeargle',
          ability: 'owntempo',
          moves: ['thundershock', 'powdersnow', 'powergem'],
        },
      ],
    ]);
  ...
  it('should not negate the type weaknesses of any other type, even if the Pokemon is Flying-type', () => {
    battle = common.createBattle([
  ...
  it('should not reduce damage from Stealth Rock', () => {
    battle = common.createBattle([
      [
    ...
    assert.hurtsBy(pokemon, Math.floor(pokemon.maxhp / 2), () =>
  ...
  it('should cause the Delta Stream weather to fade if it switches out and no other Delta Stream Pokemon are active', () => {
    battle = common.createBattle([
      [
        { species: 'Rayquaza', ability: 'deltastream', moves: ['helpinghand'] },
        { species: 'Ho-Oh', ability: 'pressure', moves: ['roost'] },
    ...
    assert.sets(
      () => battle.field.isWeather('deltastream'),
      false,
      () => battle.makeChoices('switch 2', 'move roost')
    );
  });

  it('should not cause the Delta Stream weather to fade if it switches out and another Delta Stream Pokemon is active', () => {
    battle = common.createBattle([
      [
        { species: 'Rayquaza', ability: 'deltastream', moves: ['helpinghand'] },
        { species: 'Ho-Oh', ability: 'pressure', moves: ['roost'] },
    ...
    assert.constant(
      () => battle.field.isWeather('deltastream'),
      () => battle.makeChoices('switch 2', 'move bulkup')
    );
  });

  it('should cause the Delta Stream weather to fade if its ability is suppressed and no other Delta Stream Pokemon are active', () => {
    battle = common.createBattle([
      [{ species: 'Rayquaza', ability: 'deltastream', moves: ['helpinghand'] }],
    ...
    assert.sets(
      () => battle.field.isWeather('deltastream'),
      false,
      () => battle.makeChoices('move helpinghand', 'move gastroacid')
    );
  });

  it('should not cause the Delta Stream weather to fade if its ability is suppressed and another Delta Stream Pokemon is active', () => {
    battle = common.createBattle([
      [{ species: 'Rayquaza', ability: 'deltastream', moves: ['helpinghand'] }],
  ...
  it('should cause the Delta Stream weather to fade if its ability is changed and no other Delta Stream Pokemon are active', () => {
    battle = common.createBattle([
      [{ species: 'Rayquaza', ability: 'deltastream', moves: ['helpinghand'] }],
    ...
    assert.sets(
      () => battle.field.isWeather('deltastream'),
      false,
      () => battle.makeChoices('move helpinghand', 'move entrainment')
    );
  });
});
