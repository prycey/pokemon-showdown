...
describe('Magnet Pull', () => {
  ...
  it('should prevent Steel-type Pokemon from switching out normally', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Magnezone', ability: 'magnetpull', moves: ['soak', 'charge'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should not prevent Steel-type Pokemon from switching out using moves', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Magnezone', ability: 'magnetpull', moves: ['toxic'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should not prevent Pokemon immune to trapping from switching out', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Magnezone', ability: 'magnetpull', moves: ['substitute'] }],
    });
    battle.setPlayer('p2', {
      team: [
