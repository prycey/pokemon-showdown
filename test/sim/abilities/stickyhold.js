...
describe('Sticky Hold', () => {
  ...
  it('should prevent held items from being stolen by most moves or abilities', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Shuckle', ability: 'stickyhold', item: 'razzberry', moves: ['recover'] }],
    });
    battle.setPlayer('p2', {
      team: [
  ...
  it('should be suppressed by Mold Breaker', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Pangoro', ability: 'moldbreaker', moves: ['knockoff'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Shuckle', ability: 'stickyhold', item: 'ironball', moves: ['rest'] }],
    });
