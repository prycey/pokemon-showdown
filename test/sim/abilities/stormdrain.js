...
describe('Storm Drain', () => {
  ...
  it('should grant immunity to Water-type moves and boost Special Attack by 1 stage', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Gastrodon', ability: 'stormdrain', moves: ['sleeptalk'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Azumarill', ability: 'thickfat', moves: ['aquajet'] }],
    });
  ...
  it('should redirect single-target Water-type attacks to the user if it is a valid target', () => {
    ...
    battle.makeChoices(
      'move sleeptalk, move aquajet 1, move aquajet 1',
      'move aquajet 3, move aquajet 3, move aquajet 2'
    );
