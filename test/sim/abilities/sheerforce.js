...
describe('Sheer Force', () => {
  ...
  it('should not eliminate Life Orb recoil in a move with no secondary effects', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Tauros', ability: 'sheerforce', item: 'lifeorb', moves: ['earthquake'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Lapras', ability: 'shellarmor', item: 'laggingtail', moves: ['rest'] }],
    });
  ...
  it('should eliminate secondary effects from moves', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Tauros', ability: 'sheerforce', moves: ['zapcannon'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Machamp', ability: 'noguard', moves: ['bulkup'] }],
    });
      ...
      team: [
        {
          ...
          ability: 'sheerforce',
          item: 'lifeorb',
          moves: ['lockon', 'dynamicpunch'],
        },
      ],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Scyther', ability: 'mummy', moves: ['irondefense'] }],
    });
  ...
  it('should eliminate Life Orb recoil in a move with secondary effects', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Tauros', ability: 'sheerforce', item: 'lifeorb', moves: ['bodyslam'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Lapras', ability: 'shellarmor', item: 'laggingtail', moves: ['rest'] }],
    });
