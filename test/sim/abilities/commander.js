...
describe('Commander', () => {
  ...
  it(`should not work if another Pokemon is Transformed into Tatsugiri`, () => {
    ...
    assert.false(
      !!dondozo.volatiles['commanded'],
      `Transformed Sunkern into another Tatsugiri should not trigger Commander`
    );
  });
  ...
  it(`should prevent all kinds of switchouts`, () => {
      ...
      [
        {
          ...
          item: 'redcard',
          ability: 'noguard',
          moves: ['sleeptalk', 'tackle', 'dragontail'],
        },
        {
          species: 'gyarados',
          item: 'ejectbutton',
          ability: 'intimidate',
          moves: ['sleeptalk', 'trick', 'roar'],
        },
      ],
      [
        { species: 'tatsugiri', ability: 'commander', moves: ['sleeptalk'] },
    ...
    assert.equal(
      battle.requestState,
      'move',
      'It should not have switched out on standard phazing moves'
    );
  });
