...
describe('Lightning Rod', () => {
  ...
  it('should redirect single-target Electric-type attacks to the user if it is a valid target', function () {
    ...
    battle.makeChoices(
      'move sleeptalk, move thunderbolt 1, move thunderbolt 1',
      'move thunderbolt 3, move thunderbolt 3, move thunderbolt 2'
    );
  ...
  it('should redirect to the Pokemon having the ability longest', () => {
    ...
    battle.makeChoices(
      'move roleplay -2, move sleeptalk',
      'move thunderbolt 1, move thunderbolt 2'
    );
