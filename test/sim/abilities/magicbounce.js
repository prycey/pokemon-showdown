...
describe('Magic Bounce', () => {
  ...
  it('should bounce Growl', () => {
    ...
    battle.setPlayer('p1', {
      team: [{ species: 'Bulbasaur', ability: 'overgrow', moves: ['growl'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Espeon', ability: 'magicbounce', moves: ['futuresight'] }],
    });
  ...
  it('should bounce once when target and source share the ability', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Xatu', ability: 'magicbounce', moves: ['roost'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Espeon', ability: 'magicbounce', moves: ['growl'] }],
    });
  ...
  it('should not cause a choice-lock', () => {
    ...
    battle.setPlayer('p2', {
      team: [{ species: 'Espeon', ability: 'magicbounce', moves: ['growl', 'recover'] }],
    });
  ...
  it('should be suppressed by Mold Breaker', () => {
    battle = common.createBattle();
    battle.setPlayer('p1', {
      team: [{ species: 'Bulbasaur', ability: 'moldbreaker', moves: ['growl'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Espeon', ability: 'magicbounce', moves: ['futuresight'] }],
    });
