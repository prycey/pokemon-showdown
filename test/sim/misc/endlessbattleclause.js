...
describe('Endless Battle Clause (slow)', () => {
  ...
  it('should not trigger by both Pokemon eating a Leppa Berry they started with', () => {
    battle = common.createBattle({ endlessBattleClause: true });
    battle.setPlayer('p1', {
      team: [{ species: 'Sunkern', item: 'leppaberry', moves: ['synthesis'] }],
    });
    battle.setPlayer('p2', {
      team: [{ species: 'Sunkern', item: 'leppaberry', moves: ['synthesis'] }],
    });
      ...
      team: [
        {
          ...
          level: 1,
          item: 'leppaberry',
          moves: ['recycle', 'extremespeed', 'floralhealing', 'block'],
        },
      ...
      team: [
        {
          ...
          level: 1,
          item: 'leppaberry',
          moves: ['recycle', 'extremespeed', 'fling', 'block'],
        },
        { species: 'Magikarp', moves: ['splash'] },
      ],
    });
      ...
      team: [
        {
          ...
          level: 1,
          item: 'leppaberry',
          moves: ['recycle', 'extremespeed', 'entrainment', 'block'],
        },
        { species: 'Magikarp', moves: ['splash'] },
      ],
    });
