...
describe('Modlog conversion script', () => {
  ...
  describe('log modernizer', () => {
    ...
    it('should correctly parse old-format promotions and demotions', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [annika] was promoted to Voice by [heartofetheria].'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) ([annika] was demoted to Room regular user by [heartofetheria].)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) ROOMREGULAR USER: [annika] by heartofetheria: (demote)'
      );
      assert.equal(
        converter.modernizeLog(
          `[2017-05-31T22:00:33.159Z] (espanol) vodsrtrainer MAR cos was demoted to Room regular user by [blazask].`
        ),
        `[2017-05-31T22:00:33.159Z] (espanol) ROOMREGULAR USER: [vodsrtrainermarcos] by blazask: (demote)`
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) ([annika] was demoted to Room Moderator by [heartofetheria].)'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [annika] was appointed Room Owner by [heartofetheria].'
        ),
    ...
    it('should correctly parse entries about modchat and modjoin', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) ([annika] set modchat to autoconfirmed)'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) Annika turned off modjoin.'
        ),
        '[2020-08-23T19:50:49.944Z] (development) MODJOIN: by annika: OFF'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) Annika set modjoin to sync.'
        ),
    ...
    it('should correctly parse modnotes', () => {
      assert.equal(
        converter.modernizeLog(
          `[2020-08-23T19:50:49.944Z] (development) ([annika] notes: I'm making a modnote)`
        ),
        `[2020-08-23T19:50:49.944Z] (development) NOTE: by annika: I'm making a modnote`
      );
      assert.equal(
        converter.modernizeLog(
          `[2017-10-04T20:48:14.592Z] (bigbang) (Lionyx notes: test was banned by lionyx`
        ),
    ...
    it('should correctly parse roomintro and staffintro entries', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika changed the roomintro.)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) ROOMINTRO: by annika'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika changed the staffintro.)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) STAFFINTRO: by annika'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika deleted the roomintro.)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) DELETEROOMINTRO: by annika'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika deleted the staffintro.)'
        ),
    ...
    it('should correctly parse room description changes', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) ([annika] changed the roomdesc to: "a description".)'
        ),
    ...
    it('should correctly parse declarations', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) Annika declared I am declaring something'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) Annika globally declared (chat level) I am chat declaring something'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) Annika globally declared I am globally declaring something'
        ),
    ...
    it('should correctly parse entries about roomevents', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika edited the roomevent titled "Writing Unit Tests".)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) ROOMEVENT: by annika: edited "Writing Unit Tests"'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika removed a roomevent titled "Writing Unit Tests".)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) ROOMEVENT: by annika: removed "Writing Unit Tests"'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) (Annika added a roomevent titled "Writing Unit Tests".)'
        ),
    ...
    it('should correctly parse old-format tournament modlogs', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (tournaments) ([annika] created a tournament in randombattle format.)'
        ),
        '[2020-08-23T19:50:49.944Z] (tournaments) TOUR CREATE: by annika: randombattle'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (tournaments) ([heartofetheria] was disqualified from the tournament by Annika)'
        ),
        '[2020-08-23T19:50:49.944Z] (tournaments) TOUR DQ: [heartofetheria] by annika'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (tournaments) (The tournament auto disqualify timeout was set to 2 by Annika)'
        ),
        '[2020-08-23T19:50:49.944Z] (tournaments) TOUR AUTODQ: by annika: 2'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (tournaments) (The tournament auto disqualify timer was set to 2 by Annika)'
        ),
        '[2020-08-23T19:50:49.944Z] (tournaments) TOUR AUTODQ: by annika: 2'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (tournaments) (The tournament auto start timer was set to 2 by Annika)'
        ),
        '[2020-08-23T19:50:49.944Z] (tournaments) TOUR AUTOSTART: by annika: 2'
      );
      assert.equal(
        converter.modernizeLog(
          `[2017-04-23T05:58:24.988Z] (development) (Lady Monita set the tournament's banlist to Leppa Berry.)`
        ),
        `[2017-04-23T05:58:24.988Z] (development) TOUR BANLIST: by ladymonita: Leppa Berry`
      );
      assert.equal(
        converter.modernizeLog(
          `[2017-12-06T18:58:01.953Z] (development) (Hydreigon Specs set the tournament's custom rules to +Landorus, +Zeraora.)`
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          `[2017-06-22T16:35:33.414Z] (development) ([thetournament] was set to autostart when the player cap is reached by Lady Monita)`
        ),
        `[2017-06-22T16:35:33.414Z] (development) TOUR AUTOSTART: by ladymonita: when playercap is reached`
      );
      assert.equal(
        converter.modernizeLog(
          `[2015-09-19T13:30:44.740Z] (development) ([thetournament] was set to disallow scouting by SparksBlade)`
        ),
        `[2015-09-19T13:30:44.740Z] (development) TOUR SCOUT: by sparksblade: disallow`
      );
      assert.equal(
        converter.modernizeLog(
          `[2015-09-19T13:30:44.740Z] (development) ([thetournament] was set to allow scouting by SparksBlade)`
        ),
    ...
    it('should correctly parse old-format roombans', () => {
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [heartofetheria] was banned from room development by annika (reason)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) ROOMBAN: [heartofetheria] by annika: reason'
      );
      assert.equal(
        converter.modernizeLog(
          `[2015-06-07T13:44:30.057Z] (shituusers) ROOMBAN: [eyan] (You have been kicked by +Cynd(~'e')~quil. Reason: Undefined) by shituubot`
        ),
    ...
    it('should correctly parse old-format blacklists', () => {
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [heartofetheria] was blacklisted from Development by Annika. (reason)'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [heartofetheria] was nameblacklisted from Development by Annika.'
        ),
        '[2020-08-23T19:50:49.944Z] (development) NAMEBLACKLIST: [heartofetheria] by annika'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [heartofetheria] was nameblacklisted from Development by Annika. (reason)'
        ),
    ...
    it('should correctly parse old-format mutes', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [heartofetheria] was muted by annikafor1hour (reason)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) HOURMUTE: [heartofetheria] by annika: reason'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) heartofetheria was muted by Annika for 1 hour (reason)'
        ),
        '[2020-08-23T19:50:49.944Z] (development) HOURMUTE: [heartofetheria] by annika: reason'
      );
      assert.equal(
        converter.modernizeLog(
          '[2016-09-27T18:25:55.574Z] (swag) harembe⚠ was muted by rubyfor1hour (harembe was promoted to ! by ruby.)'
        ),
    ...
    it('should correctly parse old-format weeklocks', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) heartofetheria was locked from talking for a week by annika (reason) [IP]'
        ),
    ...
    it('should correctly parse old-format global bans', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) [heartofetheria] was banned by annika (reason) [IP]'
        ),
    ...
    it('should correctly parse poll modlogs', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) ([apoll] was started by [annika].)'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (development) ([thepoll] was ended by [annika].)'
        ),
    ...
    it('should correctly parse Trivia modlogs', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (trivia) (User annika won the game of Triumvirate mode trivia under the All category with a cap of 50 points, with 50 points and 10 correct answers! Second place: heartofetheria (10 points), third place: hordeprime (5 points))'
        ),
    ...
    it('should handle claiming helptickets', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) Annika claimed this ticket.'
        ),
        '[2020-08-23T19:50:49.944Z] (help-heartofetheria) TICKETCLAIM: by annika'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) This ticket is now claimed by Annika.'
        ),
        '[2020-08-23T19:50:49.944Z] (help-heartofetheria) TICKETCLAIM: by annika'
      );
      assert.equal(
    ...
    it('should handle closing helptickets', () => {
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) This ticket is no longer claimed.'
        ),
        '[2020-08-23T19:50:49.944Z] (help-heartofetheria) TICKETUNCLAIM'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) Heart of Etheria is no longer interested in this ticket.'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) Annika closed this ticket.'
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) Annika deleted this ticket.'
        ),
    ...
    it('should handle opening helptickets', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (help-heartofetheria) Heart of Etheria opened a new ticket. Issue: Being trapped in a unit test factory'
        ),
    ...
    it('should handle Scavengers modlogs', () => {
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (scavengers) SCAV SETHOSTPOINTS: [room: subroom] by annika: 42'
        ),
        '[2020-08-23T19:50:49.944Z] (scavengers) SCAV SETHOSTPOINTS: by annika: 42 [room: subroom]'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (scavengers) SCAV TWIST: [room: subroom] by annika: your mom'
        ),
        '[2020-08-23T19:50:49.944Z] (scavengers) SCAV TWIST: by annika: your mom [room: subroom]'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (scavengers) SCAV SETPOINTS: [room: subroom] by annika: ååååååå'
        ),
        '[2020-08-23T19:50:49.944Z] (scavengers) SCAV SETPOINTS: by annika: ååååååå [room: subroom]'
      );
      assert.equal(
        converter.modernizeLog(
          '[2020-08-23T19:50:49.944Z] (scavengers) ([annika] has been caught attempting a hunt with 2 connections on the account. The user has also been given 1 infraction point on the player leaderboard.)'
        ),
    ...
    it('should handle Wi-Fi modlogs', () => {
      assert.equal(
        converter.modernizeLog(
          `[2020-08-23T19:50:49.944Z] (wifi) GIVEAWAY WIN: Annika won Heart of Etheria's giveaway for a "deluxe shitposter 1000" (OT: Entrapta TID: 1337)`
        ),
      ...
      assert.equal(
        converter.modernizeLog(
          `[2020-08-23T19:50:49.944Z] (wifi) GTS FINISHED: Annika has finished their GTS giveaway for "deluxe shitposter 2000"`
        ),
    ...
    it('should handle global declarations mentioning promotions correctly', () => {
      assert.equal(
        converter.modernizeLog(
          `[2015-07-21T06:04:54.369Z] (lobby) xfix declared GrumpyGungan was promoted to a global voice, feel free to congratulate him :-).`
        ),
    ...
    it('should handle hangman and UNO games', () => {
      assert.equal(
        converter.modernizeLog(
          `[2016-09-22T19:07:35.411Z] (development) ([agameofhangman] was started by [br3to].)`
        ),
        `[2016-09-22T19:07:35.411Z] (development) HANGMAN: by br3to`
      );
      assert.equal(
        converter.modernizeLog(
          `[2017-05-07T18:34:40.730Z] (development) ([agameofunowas] created by [jinkazaragi].)`
        ),
  ...
  describe('text entry to ModlogEntry converter', () => {
    it('should correctly parse modernized promotions and demotions', () => {
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) ROOMMODERATOR: [annika] by heartofetheria`
        ),
        {
          action: 'ROOMMODERATOR',
          roomID: 'development',
          userid: 'annika',
          isGlobal: false,
          loggedBy: 'heartofetheria',
          time: 1598212249944,
          alts: [],
      ...
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) ROOMVOICE: [annika] by heartofetheria: (demote)`
        ),
        {
          action: 'ROOMVOICE',
          roomID: 'development',
    ...
    it('should not mess up HIDEALTSTEXT', () => {
      ...
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) HIDEALTSTEXT: [auser] alts:[alt1] by annika: hnr`
        ),
        {
          action: 'HIDEALTSTEXT',
          roomID: 'development',
    ...
    it('should correctly parse modernized punishments, including alts/IP/autoconfirmed', () => {
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) WEEKLOCK: [gejg] ac: [annika] alts: [annalytically], [heartofetheria] [127.0.0.1] by somemod: terrible user`
        ),
        {
          action: 'WEEKLOCK',
          roomID: 'development',
          userid: 'gejg',
          autoconfirmedID: 'annika',
          alts: ['annalytically', 'heartofetheria'],
          ip: '127.0.0.1',
          isGlobal: false,
          loggedBy: 'somemod',
          note: 'terrible user',
      ...
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) WEEKLOCK: [gejg] alts:[annalytically] [127.0.0.1] by somemod: terrible user`
        ),
        {
          action: 'WEEKLOCK',
          roomID: 'development',
      ...
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) WEEKLOCK: [gejg] [127.0.0.1] by somemod: terrible user`
        ),
        {
          action: 'WEEKLOCK',
          roomID: 'development',
    ...
    it('should correctly parse modnotes', () => {
      assert.deepEqual(
        converter.parseModlog(
          `[2020-08-23T19:50:49.944Z] (development) NOTE: by annika: HELP! I'm trapped in a unit test factory...`
        ),
        {
          action: 'NOTE',
          roomID: 'development',
          isGlobal: false,
          loggedBy: 'annika',
          note: `HELP! I'm trapped in a unit test factory...`,
          time: 1598212249944,
          alts: [],
          autoconfirmedID: null,
          ip: null,
    ...
    it('should correctly parse visual roomids', () => {
      const withVisualID = converter.parseModlog(
        `[time] (battle-gen7randombattle-1 tournament: development) SOMETHINGBORING: by annika`
      );
      ...
      const noVisualID = converter.parseModlog(
        `[time] (battle-gen7randombattle-1) SOMETHINGBORING: by annika`
      );
    ...
    it('should properly handle OLD MODLOG', () => {
      assert.deepEqual(
        ...
        ),
        {
          ...
          isGlobal: false,
          loggedBy: 'unknown',
          note: `[punchoface] would be muted by [thecaptain] but was already muted.)`,
          time: 1416491160288,
          alts: [],
          autoconfirmedID: null,
          ip: null,
    ...
    it('should correctly handle modlog entries with an IP but no userid', () => {
      assert.deepEqual(
        converter.parseModlog(
          `[2020-09-30T20:02:12.456Z] (lobby) SHAREDIP: [127.0.0.1] by annika: j`
        ),
        {
          action: 'SHAREDIP',
          roomID: 'lobby',
      ...
      assert.deepEqual(
        converter.parseModlog(
          `[2020-09-30T20:02:12.456Z] (lobby) UNSHAREDIP: [127.0.0.1] by annika`
        ),
        {
          action: 'UNSHAREDIP',
          roomID: 'lobby',
    ...
    it('should correctly handle trivia', () => {
      assert.deepEqual(
        converter.parseModlog(
          `[2020-09-19T23:25:24.908Z] (trivia) TRIVIAGAME: by snowjy: User one for my baby won the game of Timer mode trivia under the Sub-Category 2 category with no score cap, with 69 points and 19 correct answers Second place: Mystiphox (45 points), third place: Mukund (41 points)`
        ),
        {
          action: 'TRIVIAGAME',
          roomID: 'trivia',
          ...
          autoconfirmedID: null,
          ip: null,
          note: 'User one for my baby won the game of Timer mode trivia under the Sub-Category 2 category with no score cap, with 69 points and 19 correct answers Second place: Mystiphox (45 points), third place: Mukund (41 points)',
          userid: null,
          visualRoomID: '',
        }
      );
  ...
  describe('reversability', () => {
    ...
    it('multiline entries should be reversible', () => {
      const originalConvert = converter
        .rawifyLog(
          converter.parseModlog(
      ...
      assert.equal(
        originalConvert,
        converter.rawifyLog(converter.parseModlog(originalConvert)).replace('\n', '')
      );
    });
  });
  ...
  describe.skip('integration tests', () => {
    ...
    it('should convert from text to SQLite, including old-format lines and nonsense lines', async () => {
      ...
      const mlConverter = new converter.ModlogConverterTxt(
        '',
        '',
        new Map([
      ...
      const globalEntries = database
        .prepare(
          `SELECT *, (SELECT group_concat(userid, ',') FROM alts WHERE alts.modlog_id = modlog.modlog_id) as alts FROM modlog WHERE is_global = 1'`
        )
        .all();
      const entries = database
        .prepare(
          `SELECT *, (SELECT group_concat(userid, ',') FROM alts WHERE alts.modlog_id = modlog.modlog_id) as alts FROM modlog WHERE roomid IN (?, ?) ORDER BY timestamp ASC`
        )
