export const ItemsText: { [id: IDEntry]: ItemText } = {
  ...
  focussash: {
    ...
    gen4: {
      shortDesc:
        "If holder's HP is full, survives all hits of one attack with at least 1 HP. Single use.",
    },
  ...
  luckypunch: {
    ...
    gen2: {
      shortDesc:
        'If held by a Chansey, its critical hit ratio is always at stage 2. (25% crit rate)',
    },
  },
  lumberry: {
    name: 'Lum Berry',
  ...
  stick: {
    ...
    gen2: {
      shortDesc:
        'If held by a Farfetch’d, its critical hit ratio is always at stage 2. (25% crit rate)',
    },
  },
  stickybarb: {
    name: 'Sticky Barb',
