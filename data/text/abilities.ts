export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
  ...
  angerpoint: {
    ...
    gen4: {
      ...
      shortDesc:
        'If this Pokemon or its substitute takes a critical hit, its Attack is raised 12 stages.',
    },
  ...
  angershell: {
    ...
    shortDesc:
      "At 1/2 or less of this Pokemon's max HP: +1 Atk, Sp. Atk, Spe, and -1 Def, Sp. Def.",
  },
  anticipation: {
    name: 'Anticipation',
  ...
  blaze: {
    ...
    shortDesc:
      "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5x with Fire attacks.",
    gen4: {
  ...
  cottondown: {
    ...
    shortDesc:
      'If this Pokemon is hit, it lowers the Speed of all other Pokemon on the field 1 stage.',
  },
  cudchew: {
    name: 'Cud Chew',
    shortDesc:
      'If this Pokemon eats a Berry, it will eat that Berry again at the end of the next turn.',
  },
  curiousmedicine: {
  ...
  flowergift: {
    ...
    gen4: {
      ...
      shortDesc:
        'If Sunny Day is active, Attack and Sp. Def of this Pokemon and its allies are 1.5x.',
    },
  },
  flowerveil: {
    name: 'Flower Veil',
  ...
  grimneigh: {
    ...
    shortDesc:
      "This Pokemon's Sp. Atk is raised by 1 stage if it attacks and KOes another Pokemon.",
  },
  guarddog: {
    name: 'Guard Dog',
  ...
  heatproof: {
    ...
    shortDesc:
      'Fire damage against this Pokemon is dealt with 1/2 offensive stat; 1/2 burn damage.',
    gen8: {
  ...
  iceface: {
    ...
    gen8: {
      ...
      shortDesc:
        'If Eiscue, the first physical hit it takes deals 0 damage. This effect is restored in Hail.',
    },
  },
  icescales: {
    name: 'Ice Scales',
  ...
  infiltrator: {
    ...
    gen6: {
      ...
      shortDesc:
        "Moves ignore substitutes and the foe's Reflect, Light Screen, Safeguard, and Mist.",
    },
    gen5: {
      desc: "This Pokemon's moves ignore the opposing side's Reflect, Light Screen, Safeguard, and Mist.",
      shortDesc:
        "This Pokemon's moves ignore the foe's Reflect, Light Screen, Safeguard, and Mist.",
    },
  },
  innardsout: {
    name: 'Innards Out',
  ...
  leafguard: {
    ...
    gen4: {
      ...
      shortDesc:
        'If Sunny Day is active, this Pokemon cannot be statused, but Rest works normally.',
    },
  },
  levitate: {
    name: 'Levitate',
  ...
  libero: {
    ...
    shortDesc:
      "This Pokemon's type changes to the type of the move it is using. Once per switch-in.",
    gen8: {
  ...
  lingeringaroma: {
    ...
    shortDesc:
      "Making contact with this Pokemon has the attacker's Ability become Lingering Aroma.",
    gen8: {
  ...
  magicguard: {
    ...
    gen4: {
      ...
      shortDesc:
        "This Pokemon can only be damaged by direct attacks, and can't be fully paralyzed.",
    },
  },
  magician: {
    name: 'Magician',
  ...
  magnetpull: {
    ...
    gen3: {
      ...
      shortDesc:
        'Prevents Steel-type Pokemon from choosing to switch out, other than this Pokemon.',
    },
  },
  marvelscale: {
    name: 'Marvel Scale',
  ...
  mirrorarmor: {
    ...
    shortDesc:
      "If this Pokemon's stat stages would be lowered, the attacker's are lowered instead.",
  },
  mistysurge: {
    name: 'Misty Surge',
  ...
  multitype: {
    ...
    gen4: {
      shortDesc:
        "If this Pokemon is an Arceus, its type changes to match its held Plate. This Pokemon cannot lose its held item due to another Pokemon's attack.",
    },
  },
  mummy: {
    name: 'Mummy',
  ...
  oblivious: {
    ...
    gen5: {
      ...
      shortDesc:
        'This Pokemon cannot be infatuated. Gaining this Ability while infatuated cures it.',
    },
  },
  opportunist: {
    name: 'Opportunist',
  ...
  overgrow: {
    ...
    shortDesc:
      "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5x with Grass attacks.",
    gen4: {
  ...
  pickpocket: {
    ...
    shortDesc:
      "If this Pokemon has no item and is hit by a contact move, it steals the attacker's item.",
  },
  pickup: {
    name: 'Pickup',
  ...
  purifyingsalt: {
    ...
    shortDesc:
      "Ghost damage to this Pokemon dealt with a halved offensive stat; can't be statused.",
  },
  quarkdrive: {
    name: 'Quark Drive',
  ...
  simple: {
    name: 'Simple',
    shortDesc:
      "When one of this Pokemon's stat stages is raised or lowered, the amount is doubled.",
    gen7: {
  ...
  supersweetsyrup: {
    ...
    shortDesc:
      'On switch-in, this Pokemon lowers the evasiveness of opponents 1 stage. Once per battle.',
  ...
  thickfat: {
    ...
    gen3: {
      ...
      shortDesc:
        'Fire-/Ice-type moves against this Pokemon deal damage with a halved Sp. Atk stat.',
    },
  },
  tintedlens: {
    name: 'Tinted Lens',
  ...
  torrent: {
    ...
    shortDesc:
      "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5x with Water attacks.",
    gen4: {
  ...
  transistor: {
    ...
    gen8: {
      shortDesc:
        "This Pokemon's offensive stat is multiplied by 1.5 while using an Electric-type attack.",
    },
  },
  triage: {
    name: 'Triage',
  ...
  voltabsorb: {
    ...
    gen3: {
      ...
      shortDesc:
        'This Pokemon heals 1/4 its max HP when hit by a damaging Electric move; immunity.',
    },
  },
  wanderingspirit: {
  ...
  weakarmor: {
    ...
    gen6: {
      ...
      shortDesc:
        'If a physical attack hits this Pokemon, Defense is lowered by 1, Speed is raised by 1.',
    },
  },
  wellbakedbody: {
  ...
  wonderguard: {
    ...
    gen4: {
      shortDesc:
        'This Pokemon is only damaged by Fire Fang, supereffective moves, indirect damage.',
    },
    gen3: {
