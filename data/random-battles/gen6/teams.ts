...
const PROTECT_MOVES = ['kingsshield', 'protect', 'spikyshield'];
...
export class RandomGen6Teams extends RandomGen7Teams {
  ...
  constructor(format: Format | string, prng: PRNG | PRNGSeed | null) {
    ...
    this.moveEnforcementCheckers = {
      ...
      Flying: (movePool, moves, abilities, types, counter, species) =>
        !counter.get('Flying') &&
        !['aerodactyl', 'aerodactylmega', 'mantine', 'murkrow'].includes(species.id) &&
      ...
      Ice: (movePool, moves, abilities, types, counter) =>
        ...
        (abilities.includes('Refrigerate') &&
          (movePool.includes('return') || movePool.includes('hypervoice'))),
  ...
  override cullMovePool(
    ...
    const incompatiblePairs = [
      ...
      [
        ['gigadrain', 'leafstorm'],
        ['leafstorm', 'petaldance', 'powerwhip'],
      ],
  ...
  override randomFactorySet(
    ...
    for (const curSet of setList) {
      ...
      if (
        weatherAbilitiesRequire[abilityState.id] &&
        teamData.weather !== weatherAbilitiesRequire[abilityState.id]
      )
        continue;
