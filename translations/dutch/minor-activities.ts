...
export const translations: Translations = {
  strings: {
    ...
    'You are not allowed to use filtered words in announcements.':
      'Je mag geen gefilterde woorden gebruiken in mededelingen.',
    'There is already a poll or announcement in progress in this room.':
      'Er loopt al een poll of mededeling in deze room.',
    'An announcement was started by ${user.name}.':
      '${user.name}. heeft een mededeling aangemaakt.',
    'There is no announcement running in this room.':
      'Er zijn momenteel geen mededelingen in deze room.',
    ...
    'you will not be able to vote after viewing results':
      'als je de uitslag hebt gezien kun je niet meer stemmen',
    ...
    'The poll has ended &ndash; scroll down to see the results':
      'De poll is voorbij &ndash; scroll naar beneden om de uitslag te zien',
    ...
    'You are not allowed to use filtered words in polls.':
      'Je mag geen gefilterde woorden gebruiken in polls.',
    'Not enough arguments for /poll new.':
      'Onvoldoende argumenten (antwoordmogelijkheden) opgegeven voor /poll new.',
    'Too many options for poll (maximum is 8).':
      'Te veel antwoordmogelijkheden voor een poll (de limiet is 8).',
    ...
    'Can\'t delete poll at slot ${slotString} - "${slotString}" is not a number.':
      'Kan poll op plek ${slotString} niet verwijderen - "${slotString}" is geen geldig getal.',
    'There is no poll in queue at slot ${slot}.':
      'Er staat geen poll op plek ${slot} van de wachtrij.',
    '(${user.name} deleted the queued poll in slot ${slot}.)':
      '(${user.name} heeft de poll op plek ${slot} van de wachtrij verwijderd.)',
    'There is no poll running in this room.': 'Er loopt momenteel geen poll in deze room.',
    'To vote, specify the number of the option.':
      'Specificeer het nummer van de optie om te stemmen.',
    ...
    'The poll timer was turned on: the poll will end in ${timeout} minute(s).':
      'De polltimer is aangezet: de poll zal over ${timeout} minuten eindigen.',
    'The poll timer was set to ${timeout} minute(s) by ${user.name}.':
      '${user.name} heeft de polltimer op ${timeout} minuten gezet.',
    'The poll timer is on and will end in ${poll.timeoutMins} minute(s).':
      'De polltimer staat aan en de poll zal over ${poll.timeoutMins} minuten eindigen.',
