...
export const translations: Translations = {
  strings: {
    ...
    'You are not allowed to use filtered words in announcements.':
      'Du darfst keine gefilterten Worte in Ankündigungen verwenden.',
    'There is already a poll or announcement in progress in this room.':
      'Es gibt bereits eine Umfrage oder Ankündigung in diesem Raum.',
    'An announcement was started by ${user.name}.':
      'Eine Ankündigung wurde von ${user.name} gestartet.',
    'There is no announcement running in this room.':
      'Derzeit gibt es keine Ankündigung in diesem Raum.',
    ...
    'The announcement was ended by ${user.name}.':
      'Die Ankündigung wurde von ${user.name} beendet.',
    ...
    'you will not be able to vote after viewing results':
      'du wirst nicht mehr abstimmen können, nachdem du die Ergebnisse eingesehen hast',
    'View results': 'Ergebnisse einsehen',
    "You can't vote after viewing results":
      'Du kannst nicht mehr abstimmen, nachdem du die Ergebnisse eingesehen hast',
    'The poll has ended &ndash; scroll down to see the results':
      'Die Umfrage wurde beendet &ndash; scrolle nach unten, um die Ergebnisse einzusehen',
    ...
    'You are not allowed to use filtered words in polls.':
      'Du darfst keine gefilterten Worte in Umfragen verwenden.',
    ...
    'Too many options for poll (maximum is 8).':
      'Es liegen zu viele Wahloptionen in der Umfrage (maximal 8) vor.',
    'There are duplicate options in the poll.':
      'Es liegen doppelte Wahloptionen in der Umfrage vor.',
    ...
    'Can\'t delete poll at slot ${slotString} - "${slotString}" is not a number.':
      'Die Umfrage kann nicht gelöscht werden an der Stelle ${slotString} - "${slotString}" ist keine Nummer.',
    'There is no poll in queue at slot ${slot}.':
      'An der Stelle ${slot} gibt es keine Umfrage in der Warteschleife.',
    '(${user.name} deleted the queued poll in slot ${slot}.)':
      '(${user.name} hat die Umfrage in der Warteschleife an der Stelle ${slot}.) gelöscht.',
    ...
    'To vote, specify the number of the option.':
      'Um abzustimmen, musst du dich für eine Wahloption entscheiden.',
    ...
    'The poll timer was turned on: the poll will end in ${timeout} minute(s).':
      'Der Umfrage-Timer wurde eingeschaltet: Die Umfrage wird in ${timeout} Minute(n) beendet.',
    'The poll timer was set to ${timeout} minute(s) by ${user.name}.':
      'Der Umfrage-Timer wurde von ${user.name} auf ${timeout} Minute(n) gestellt.',
    'The poll timer is on and will end in ${poll.timeoutMins} minute(s).':
      'Der Umfrage-Timer ist eingeschaltet und wird in ${poll.timeoutMins} Minute(n) enden.',
