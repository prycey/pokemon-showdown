...
var g = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
  en = (t, e) => {
    for (var s in e) $r(t, s, { get: e[s], enumerable: !0 });
  },
  wl = (t, e, s, r) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let n of ml(e))
        !gl.call(t, n) &&
          n !== s &&
          $r(t, n, { get: () => e[n], enumerable: !(r = dl(e, n)) || r.enumerable });
    return t;
  };
var xe = (t, e, s) => (
  (s = t != null ? hl(yl(t)) : {}),
  wl(e || !t || !t.__esModule ? $r(s, 'default', { value: t, enumerable: !0 }) : s, t)
);
var bi = g((xv, ss) => {
  var _ = String,
    xi = function () {
          ...
          return s === 'proxyOf'
            ...
            : e[s]
              ? s === 'each' || (typeof s == 'string' && s.startsWith('walk'))
                ? (...r) =>
                    e[s](...r.map(n => (typeof n == 'function' ? (i, o) => n(i.toProxy(), o) : n)))
                : s === 'every' || s === 'some'
...
var qe = g((Dv, ji) => {
  ...
  var { nanoid: Nc } = $i(),
    ...
    { fileURLToPath: Vi, pathToFileURL: zt } = {},
    zi = Wt(),
    Ic = cs(),
    fs = ns(),
    ...
    Ie = class {
      ...
      error(e, s, r, n = {}) {
        ...
        return (
          ...
          this.file && (zt && (u.input.url = zt(this.file).toString()), (u.input.file = this.file)),
          u
        );
      }
      fromOffset(e) {
      ...
      switch (((i = r.charCodeAt(d)), i)) {
        ...
        case 40: {
          if (
            ...
            (a = r.indexOf(')', d + 1)),
              (o = r.slice(d, a + 1)),
              a === -1 || Dc.test(o) ? (f = ['(', '(', d]) : ((f = ['brackets', o, d, a]), (d = a));
          break;
        }
        case 39:
        case 34: {
        ...
        case 64: {
          (Ht.lastIndex = d + 1),
            Ht.test(r),
            Ht.lastIndex === 0 ? (a = r.length - 1) : (a = Ht.lastIndex - 2),
      ...
      switch (((i = r.charCodeAt(h)), i)) {
        ...
        case 40: {
          if (
            ...
            (o = r.indexOf(')', h + 1)),
              (a = r.slice(h, o + 1)),
              o === -1 || Qf.test(a) ? (y = ['(', '(', h]) : ((y = ['brackets', a, h, o]), (h = o));
          break;
        }
        case 39:
        case 34: {
        ...
        case 64: {
          (rr.lastIndex = h + 1),
            rr.test(r),
            rr.lastIndex === 0 ? (o = r.length - 1) : (o = rr.lastIndex - 2),
...
var B = g(M => {
  ...
  var Ox = (M.TAG = 'tag'),
    Ax = (M.STRING = 'string'),
    Nx = (M.SELECTOR = 'selector'),
    Px = (M.ROOT = 'root'),
    Rx = (M.PSEUDO = 'pseudo'),
    Ix = (M.NESTING = 'nesting'),
    qx = (M.ID = 'id'),
    Lx = (M.COMMENT = 'comment'),
    Dx = (M.COMBINATOR = 'combinator'),
    Bx = (M.CLASS = 'class'),
    Mx = (M.ATTRIBUTE = 'attribute'),
    Ux = (M.UNIVERSAL = 'universal');
});
var ar = g((or, ba) => {
  'use strict';
  or.__esModule = !0;
    ...
    return (
      (e.prototype.toString = function () {
        ...
        return (
          ...
          this.raws.insensitive ? r.push(this.raws.insensitive) : this.insensitive && r.push(' i'),
          r.push(']'),
    ...
    for (
      ...
      switch (((r = s.charCodeAt(m)), r === St && ((h = m), (d += 1)), r)) {
        ...
        case Ud:
          (_r.lastIndex = m + 1),
            _r.test(s),
            _r.lastIndex === 0 ? (n = s.length - 1) : (n = _r.lastIndex - 2),
...
var G = g((Vx, cu) => {
  ...
  cu.exports = class {
    ...
    moveAfter(e) {
      return (
        this.cleanRaws(this.root() === e.root()), this.remove(), e.parent.insertAfter(e, this), this
      );
    }
    next() {
      let e = this.parent.index(this);
...
var Qu = g((fb, Ku) => {
  ...
  Ku.exports = class {
    ...
    newNode(e) {
      return (
        this.spaces && ((e.raws.before += this.spaces), (this.spaces = '')), this.current.append(e)
      );
    }
    get currToken() {
      return this.tokens[this.position];
...
var be = 'string',
  ...
  je = 'label',
  ke = 'break-parent',
  Tt = new Set([Ye, te, _e, Ve, re, se, ne, ze, Ee, Ge, j, je, ke]);
var xl = (t, e, s) => {
    if (!(t && e == null))
  ...
  function n(i) {
    switch (H(i)) {
      ...
      case re: {
        ...
        return (
          o ? ((o = o.map(r)), (u = o[0])) : (u = r(u)), e({ ...i, contents: u, expandedStates: o })
        );
      }
      case _e:
      case te:
...
function _n(t, e) {
  var s, r, n;
  if (
    typeof ((r = (s = t.source) == null ? void 0 : s.start) == null ? void 0 : r.offset) == 'number'
  )
...
function Wn(t, e) {
  ...
  return (
    ((r = s == null ? void 0 : s.name) == null ? void 0 : r.toLowerCase().endsWith('keyframes')) &&
...
function Qr(t) {
  var e;
  return (
    t.type === 'value-paren_group' && ((e = t.groups) == null ? void 0 : e[0]) && Dt(t.groups[0])
  );
}
function Xr(t, e) {
  var i;
...
function nt(t) {
  return (
    (t == null ? void 0 : t.type) === 'value-atword' && t.value.startsWith('prettier-placeholder-')
  );
}
function oi(t, e) {
  var s, r;
...
function Zl(t, e, s) {
  ...
  return (
    f && l.push([l.pop(), Ke]), h && l.unshift('', S), c ? L(q(l)) : Vn(t) ? L(Se(l)) : L(q(Se(l)))
  );
}
var ai = Zl;
function ec(t) {
...
function lc(t, e) {
  ...
  return (r = di(t, r)), (r = Ut(t, r)), r !== !1 && Ft(t, r);
}
var $t = lc;
  ...
  return (
    t.each(() => {
      ...
      if (
        ...
        return;
      let { next: o } = t;
      (o.type === 'css-comment' && !Ft(e.originalText, P(o), { backwards: !0 }) && !Te(n)) ||
      (o.type === 'css-atrule' && o.name === 'else' && n.type !== 'css-comment')
        ? r.push(' ')
        : (r.push(e.__isHTMLStyleAttribute ? A : S),
          $t(e.originalText, R(n)) && !Te(n) && r.push(S));
    }, 'nodes'),
    r
  );
}
...
function mc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case 'css-atrule': {
      let f = t.parent,
        p = Lt(r) && !f.raws.semicolon && e.originalText[R(r) - 1] !== ';';
      if (e.parser === 'less') {
      ...
      return [
        '@',
        Jr(r) || r.name.endsWith(':') || Lt(r) ? r.name : ue(r.name),
        r.params
          ? [
              Jr(r)
                ? ''
  ...
  for (let c = 0; c < s.length; ++c) {
    ...
    if (
      ...
      f.type === 'func' &&
        f.value === 'selector' &&
        (f.group.groups = [
          ee(Ur(t).text.slice(f.group.open.sourceIndex + 1, f.group.close.sourceIndex)),
        ]),
...
function Fr(t) {
  return (t.type === 'paren_group' && !t.open && !t.close && t.groups.length === 1) ||
    ...
    : t.type === 'paren_group' || t.type === 'comma_group'
      ? { ...t, groups: t.groups.map(Fr) }
      : t;
}
function sl(t, e) {
  if (t && typeof t == 'object')
    for (let s in t)
      s !== 'parent' && (sl(t[s], e), s === 'nodes' && ((t.group = Fr(Ey(t, e))), delete t[s]));
  return t;
}
function ky(t, e) {
...
var Iy = { postcss: yi };
var Gb = Xs;
export { Gb as default, gi as languages, vi as options, Js as parsers, Iy as printers };
