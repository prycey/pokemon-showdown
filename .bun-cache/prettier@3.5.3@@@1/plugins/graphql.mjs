...
function I(e, t = '', n = {}) {
  return L(e), t !== '' && L(t), { type: F, breakContents: e, flatContents: t, groupId: n.groupId };
}
var Tt = { type: J };
...
function Vt(e, t) {
  ...
  for (; r < i; ) {
    ...
    switch (s) {
      ...
      case 34:
        return n.charCodeAt(r + 1) === 34 && n.charCodeAt(r + 2) === 34 ? Xt(e, r) : jt(e, r);
    }
...
var Te = class {
  ...
  parseDirective(t) {
    ...
    return (
      ...
      this.node(n, { kind: c.DIRECTIVE, name: this.parseName(), arguments: this.parseArguments(t) })
    );
  }
  parseTypeReference() {
    let t = this._lexer.token,
