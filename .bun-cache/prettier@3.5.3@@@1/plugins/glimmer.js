(function (f) {
  ...
  var He = (e, t) => {
      for (var r in t) Fe(e, r, { get: t[r], enumerable: !0 });
    },
    Js = (e, t, r, s) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let n of js(t))
          !Qs.call(e, n) &&
            n !== r &&
            Fe(e, n, { get: () => t[n], enumerable: !(s = Ws(t, n)) || s.enumerable });
      return e;
    };
  var $s = e => Js(Fe({}, '__esModule', { value: !0 }), e);
  ...
  var xi = {};
  He(xi, { languages: () => ps, parsers: () => xr, printers: () => Pi });
  var Xs = (e, t, r, s) => {
      if (!(e && t == null))
  ...
  var qt = tn;
  var en = e => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(e);
  function rn(e) {
...
`)
  ...
  var Vr = { type: Rt };
  var on = { type: j, hard: !0 },
    ln = { type: j, hard: !0, literal: !0 },
    L = { type: j },
    H = { type: j, soft: !0 },
    tt = [on, Vr],
    Rr = [ln, Vr];
...
`,
  ...
  var mn = 10;
  for (let e = 0; e <= mn; e++) ee();
  function $e(e) {
    return ee(e);
  }
  function dn(e, t = 'type') {
    $e(e);
    function r(s) {
      let n = s[t],
        i = e[n];
  ...
  function Xe(e) {
    return e.selfClosing === !0 || yn(e.tag) || (bn(e) && e.children.every(t => ge(t)));
  }
  function ge(e) {
  ...
  function kn(e, t, r) {
    ...
    switch (s.type) {
      ...
      case 'BlockStatement':
        return Pn(e)
          ? [xn(e, r), es(e, r, t), rs(e, r, t)]
          : [Nn(e, r), R([es(e, r, t), rs(e, r, t), An(e, r, t)])];
  ...
  function vn(e, t) {
    let { node: r } = e,
      ...
      n = s.flatMap(i => r[i]).sort(Sn);
    for (let i of s)
      e.each(({ node: a }) => {
        let o = n.indexOf(a);
        n.splice(o, 1, [L, t()]);
      }, i);
    return Zt(r.blockParams) && n.push(L, tr(r)), ['<', r.tag, B(n), En(r)];
  }
  function Xr(e, t, r) {
    let { node: s } = e,
  ...
  function Nn(e, t) {
    ...
    return (
      n && s.push(R(n)),
      Zt(r.program.blockParams) && s.push(tr(r.program)),
      R([wn(r), Ze(e, t), s.length > 0 ? B([L, yt(L, s)]) : '', H, Tn(r)])
    );
  }
  function Cn(e, t) {
  ...
  function xn(e, t) {
    ...
    return R([
      ...
      B([L, R(ke(e, t)), ...(Zt(r.program.blockParams) ? [L, tr(r.program)] : [])]),
      H,
      os(s),
    ]);
  }
...
`).length - 1
  ...
  function Bn(e, t) {
    let {
      ...
      s = de(r, In(e) ? !t.singleQuote : t.singleQuote);
    return [s, Ue(!1, r, s, `\\${s}`), s];
  }
  function In(e) {
    let { ancestors: t } = e,
  ...
  var qn = new Set('!"#%&\'()*+,./;<=>@[\\]^`{|}~'),
    Vn = new Set(['true', 'false', 'null', 'undefined']),
    Fn = (e, t) =>
      t === 0 && e.startsWith('@')
        ? !1
        : (t !== 0 && Vn.has(e)) ||
          /\s/u.test(e) ||
          /^\d/u.test(e) ||
          Array.prototype.some.call(e, r => qn.has(r));
  function Hn(e) {
    return e.tail.length === 0 && e.original.includes('/')
      ? e.original
      : [e.head.original, ...e.tail].map((r, s) => (Fn(r, s) ? `[${r}]` : r)).join('.');
  }
  var Un = { print: kn, massageAstNode: zr, hasPrettierIgnore: $r, getVisitorKeys: Wr, embed: Yr },
    hs = Un;
  var ps = [
    {
      ...
      var e = function (it, d, k, g) {
        ...
        _e = {
          ...
          parse: function (d) {
            ...
            var Ie = x.yylloc;
            l.push(Ie);
            var Gs = x.options && x.options.ranges;
            ...
            for (
              var Ks = function () {
                  var W;
                  return (W = x.lex() || Dr), typeof W != 'number' && (W = k.symbols_[W] || W), W;
                },
                O,
                Re,
                gt,
              ...
              if (
                ...
                this.defaultActions[gt]
                  ...
                  : ((O === null || typeof O > 'u') && (O = Ks()), (M = xt[gt] && xt[gt][O])),
              ...
              switch (M[0]) {
                ...
                case 2:
                  if (
                    ...
                    Gs &&
                      (At._$.range = [l[l.length - (Z || 1)].range[0], l[l.length - 1].range[1]]),
                  ...
                  Z &&
                    ...
                    N.push(At.$),
                    l.push(At._$),
                    (_r = xt[g[g.length - 2]][g[g.length - 1]]),
                    g.push(_r);
                  break;
                case 3:
                  return !0;
...
` +
  ...
  function sr(e, t) {
    ...
    r &&
      ...
      (a = r.end.column),
      (e += ' - ' + s + ':' + i));
    for (var o = Error.prototype.constructor.call(this, e), c = 0; c < rr.length; c++)
      this[rr[c]] = o[rr[c]];
    ...
    Q.prototype.PartialBlockStatement =
      function (e) {
        ...
        var i = {
          ...
          openStandalone: ir(t.body),
          closeStandalone: nr((s || t).body),
        };
        if ((e.openStrip.close && vt(t.body, null, !0), r)) {
          ...
          a.open && lt(t.body, null, !0),
            ...
            !this.options.ignoreStandalone && nr(t.body) && ir(s.body) && (lt(t.body), vt(s.body));
      ...
      return (
        (e.prototype.parse = function (t) {
          if (t) {
            ...
            if (((r = t.match(ti)), r)) return String.fromCharCode(parseInt(r[1], 10));
            if (((r = t.match(ei)), r)) return this.named[r[1]];
          }
        }),
        e
      );
...
`
      ...
      return (
        ...
        (e.prototype.tokenizePart = function (t) {
          for (this.input += ii(t); this.index < this.input.length; ) {
...
`
    ...
    ao = (function () {
      function e(t, r) {
        r === void 0 && (r = {}),
          ...
          (this.startColumn = 0),
          (this.tokens = []),
          (this.tokenizer = new ur(this, t, r.mode)),
  ...
  var lo = ws(Ne.FlushElement);
  var co = ws(Ne.GetSymbol);
  var Ds = !1,
    ai = /["\x26\xa0]/u,
    ko = new RegExp(ai.source, 'gu'),
    oi = /[&<>\xa0]/u,
    So = new RegExp(oi.source, 'gu');
  var gr = new Set([
    'area',
    'base',
    'br',
  ...
  function li(e) {
    var t;
    return gr.has(e.toLowerCase()) && ((t = e[0]) == null ? void 0 : t.toLowerCase()) === e[0];
  }
  function ce(e) {
    return !!e && e.length > 0;
  }
  ...
  var pt = Object.freeze({ line: 1, column: 0 }),
    ui = Object.freeze({ source: '(synthetic)', start: pt, end: pt }),
    br = Object.freeze({ source: '(nonexistent)', start: pt, end: pt }),
  ...
  var kr = class {
    ...
    D = class e {
      static get NON_EXISTENT() {
        return new et('NonExistent', br).wrap();
      }
      static load(t, r) {
      ...
      static synthetic(t) {
        return new et('InternalsSynthetic', br, t).wrap();
      }
      static broken(t = ht) {
...
`
  ...
  function Ts(e, t, r) {
    return new Pr('Cannot remove a node unless it is part of an array', e, t, r);
  }
  function fi(e, t, r) {
    return new Pr(
  ...
  function Ns(e, t) {
    return new Pr('Replacing and removing in key handlers is not yet supported.', e, null, t);
  }
  var zt = class {
  ...
  function Ae(e, t) {
    ...
    if (n === void 0) {
      let h = pi[i.type];
      for (let p = 0; p < h.length; p++) mi(e, c, t, h[p]);
      s !== void 0 && (n = s(i, t));
    }
    return n;
  }
      ...
      if (Array.isArray(o)) Is(e, o, r, s);
        ...
        c !== void 0 &&
          (function (h, p, m, S) {
            ...
            if (Array.isArray(S)) {
              if (S.length !== 1) throw S.length === 0 ? Ts(m, h, p) : fi(m, h, p);
              Cs(h, p, S[0]);
            } else Cs(h, p, S);
          })(a, s, o, c);
      }
  ...
  var hr;
  function pr() {
    return hr || (hr = new wt('', '(synthetic)')), hr;
  }
  function Ps(e, t) {
  ...
  function T(...e) {
    if (e.length === 1) {
      let t = e[0];
      return t && typeof t == 'object' ? D.forHbsLoc(pr(), t) : D.forHbsLoc(pr(), ui);
    }
    {
      let [t, r, s, n, i] = e,
        a = i ? new wt('', i) : pr();
  ...
  var bi = {
    ...
    element: function (e, t = {}) {
      ...
      let S = i == null ? void 0 : i.map(E => (typeof E == 'string' ? Ps(E) : E)),
        y = null;
      return (
        p ? (y = T(p)) : p === void 0 && (y = s || li(r.original) ? null : T(null)),
        f.element({
          path: r,
          selfClosing: s || !1,
          attributes: n || [],
    ...
    program: function (e, t, r) {
      return t && t.length ? xs(e, t, !1, r) : As(e, [], r);
    },
    blockItself: xs,
    template: As,
    loc: T,
    ...
    string: fr('StringLiteral'),
    boolean: fr('BooleanLiteral'),
    number: fr('NumberLiteral'),
  ...
  var Ce = { close: !1, open: !1 },
      ...
      path({ head: e, tail: t, loc: r }) {
        return (function ({ head: s, tail: n, loc: i }) {
          let a = {
            ...
            set original(o) {
              let [c, ...h] = o.split('.');
              (this.head = bi.head(c, this.head.loc)), (this.tail = h);
            },
            loc: i,
          };
          return (
    ...
    Er = class {
      constructor(t, r = new cr(Es), s = 'precompile') {
        (this.elementStack = []),
          (this.currentAttribute = null),
          (this.currentNode = null),
          (this.source = t),
          (this.lines = t.source.split(/\r\n?|\n/u)),
          (this.tokenizer = new ur(this, r, s));
      }
      offset() {
      ...
      finish(t) {
        return er({}, t, { loc: t.start.until(this.offset()) });
      }
      get currentAttr() {
...
`);
    ...
    wr = class extends Er {
      ...
      BlockStatement(t) {
        ...
        let { path: r, params: s, hash: n } = mr(this, t),
        ...
        if ((m = t.program.blockParams) != null && m.length) {
          ...
          for (let P of t.program.blockParams) {
            let w, U;
            (w = E >= C ? -1 : y.indexOf(P, E)),
              w === -1 || w + P.length > C
                ? ((E = C), (U = this.source.spanFor(br)))
                : ((E = w),
                  (U = S.sliceStartChars({ skipStart: E, chars: P.length })),
                  (E += P.length)),
      ...
      MustacheStatement(t) {
        ...
        if (Rs(t.path))
          ...
          let { path: c, params: h, hash: p } = mr(this, t);
          s = f.mustache({
            path: c,
            params: h,
            hash: p,
        ...
        switch (r.state) {
          ...
          case 'afterAttributeValueQuoted':
            dr(this.currentStartTag, s), r.transitionTo('beforeAttributeName');
            break;
  ...
  var Tr = class extends wr {
      ...
      finishTag() {
        ...
        if (t.type === 'StartTag') {
          ...
          (gr.has(t.name) || t.selfClosing) && this.finishEndTag(!0);
  ...
  function Vs(e, t = {}) {
    ...
    typeof e == 'string'
      ? ((r = new wt(e, (c = t.meta) == null ? void 0 : c.moduleName)),
        (s = i === 'codemod' ? Te(e, t.parseOptions) : lr(e, t.parseOptions)))
      : e instanceof wt
        ? ((r = e),
          (s = i === 'codemod' ? Te(e.source, t.parseOptions) : lr(e.source, t.parseOptions)))
    ...
    let o = new Tr(r, n, i).parse(s, t.locals ?? []);
    if ((p = t.plugins) != null && p.ast)
      for (let m of t.plugins.ast) gi(o, m(er({}, t, { syntax: yi }, { plugins: void 0 })).visitor);
    return o;
  }
  var ki = { resolution: () => Ne.GetStrictKeyword, serialize: () => 'Strict', isAngleBracket: !1 },
    vo = { ...ki, isAngleBracket: !0 };
  var Le = `
`,
    Fs = '\r',
    Hs = (function () {
  ...
  function wi(e) {
    let t;
    try {
      t = Vs(e, { mode: 'codemod', plugins: { ast: [Ei(e)] } });
    } catch (r) {
      let s = Ni(r);
      if (s) {
        let n = Ti(r);
...
`);
  ...
  var Ci = { parse: wi, astFormat: 'glimmer', locStart: St, locEnd: re };
  var Pi = { glimmer: hs };
  return $s(xi);
});
