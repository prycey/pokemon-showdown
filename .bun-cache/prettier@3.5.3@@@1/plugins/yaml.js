    ...
    rr = (t, e, n, r) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let s of Mi(e))
          !vi.call(t, s) &&
            s !== n &&
            yt(t, s, { get: () => e[s], enumerable: !(r = Ci(e, s)) || r.enumerable });
      return t;
    };
  var sr = (t, e, n) => (
      (n = t != null ? Ti(ki(t)) : {}),
      rr(e || !t || !t.__esModule ? yt(n, 'default', { value: t, enumerable: !0 }) : n, t)
    ),
...
`
        ...
        return (
          this.valueRange.isEmpty() && (this.valueRange.start = e), (this.valueRange.end = o), o
        );
      }
      parse(e, n) {
        this.context = e;
...
`
      ...
      Dn = class extends u.Node {
        ...
        prevNodeIsJsonLike(e = this.items.length) {
          ...
          return (
            !!n && (n.jsonLike || (n.type === u.Type.COMMENT && this.prevNodeIsJsonLike(e - 1)))
          );
        }
        parse(e, n) {
          this.context = e;
      ...
      ra = {
        ...
        stringify: ({ comment: t, type: e, value: n }, r, s, i) => {
          ...
          if (typeof Buffer == 'function')
            o =
              n instanceof Buffer ? n.toString('base64') : Buffer.from(n.buffer).toString('base64');
...
`
  ...
  function Tt(t, e) {
    ...
    return (
      ...
      !s.has(n.position.end.line) && (s.add(n.position.end.line), Nr(n, e) && !dn(t.parent))
        ? Nt
        : ''
    );
  }
  ...
  function Hi(t, e, n) {
    return t.map(
      ({ isLast: r, node: s, next: i }) => [
        ...
        r
          ? ''
          : [',', ne, s.position.start.line !== i.position.start.line ? Tt(t, n.originalText) : ''],
      ],
      'children'
    );
  }
...
`);
  ...
  function no(t, e, n) {
    ...
    return (
      ...
      ie(r) &&
        s.push([r.middleComments.length === 1 ? '' : N, v(N, t.map(n, 'middleComments')), N]),
      Or(t)
      ...
      case 'quoteSingle': {
        ...
        if (o.includes(i))
          return [
            ...
            at(
              r.type,
              r.type === 'quoteDouble' ? Et(!1, Et(!1, o, String.raw`\"`, i), "'", s.repeat(2)) : o,
              e
            ),
            s,
          ];
        if (o.includes(s))
          return [i, at(r.type, r.type === 'quoteSingle' ? Et(!1, o, "''", s) : o, e), i];
