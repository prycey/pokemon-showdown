    ...
    $e = (e, t, i, s) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let r of xi(t))
          !gi.call(e, r) &&
            r !== i &&
            ce(e, r, { get: () => t[r], enumerable: !(s = mi(t, r)) || s.enumerable });
      return e;
    };
  var et = (e, t, i) => (
      (i = e != null ? di(yi(e)) : {}),
      $e(t || !e || !e.__esModule ? ce(i, 'default', { value: e, enumerable: !0 }) : i, e)
    ),
    bi = e => $e(ce({}, '__esModule', { value: !0 }), e);
  var Gt = Ze((Ys, qt) => {
    qt.exports = {};
  });
  var Je = Ze((Zs, Ge) => {
        ...
        jsx_parseElementAt(h, m) {
          ...
          if (!w.selfClosing) {
            ...
            ne(he.name) !== ne(w.name) &&
              this.raise(
                he.start,
                'Expected corresponding JSX closing tag for <' + ne(w.name) + '>'
              );
          }
...
`,
  ...
  l.parseModuleExportName = function () {
    if (this.options.ecmaVersion >= 13 && this.type === a.string) {
      ...
      return (
        Ii.test(e.value) && this.raise(e.start, 'An export name cannot include a lone surrogate.'),
        e
      );
    }
  ...
  R.parseMaybeDefault = function (e, t, i) {
    ...
    return (
      (s.left = i), (s.right = this.parseMaybeAssign()), this.finishNode(s, 'AssignmentPattern')
    );
  };
...
`
  ...
  for (le = 0, Ie = [9, 10, 11, 12, 13, 14]; le < Ie.length; le += 1) (at = Ie[le]), Wi(at);
  var at,
    le,
    Ie,
    c = T.prototype,
  ...
  c.regexp_eatClassSetRange = function (e) {
    ...
    if (this.regexp_eatClassSetCharacter(e)) {
      ...
      if (e.eat(45) && this.regexp_eatClassSetCharacter(e)) {
        ...
        return (
          i !== -1 && s !== -1 && i > s && e.raise('Range out of order in character class'), !0
        );
      }
      e.pos = t;
    }
  ...
  c.regexp_eatNestedClass = function (e) {
    ...
    if (e.eat(91)) {
      ...
      if (e.eat(93))
        return i && s === V && e.raise('Negated character class may contain strings'), s;
      e.pos = t;
    }
    if (e.eat(92)) {
