...
var $e = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  vi = (e, t) => {
    for (var i in t) we(e, i, { get: t[i], enumerable: !0 });
  },
  bi = (e, t, i, s) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let r of xi(t))
        !gi.call(e, r) &&
          r !== i &&
          we(e, r, { get: () => t[r], enumerable: !(s = mi(t, r)) || s.enumerable });
    return e;
  };
var et = (e, t, i) => (
  (i = e != null ? di(yi(e)) : {}),
  bi(t || !e || !e.__esModule ? we(i, 'default', { value: e, enumerable: !0 }) : i, e)
);
var Gt = $e((Qs, qt) => {
  qt.exports = {};
});
var Je = $e((Ys, Ge) => {
    ...
    if (!t) {
      ...
      (d.jsxTagStart.updateContext = function () {
        ...
        (d.jsxTagEnd.updateContext = function (f) {
          ...
          (C === n && f === i.slash) || C === o
            ? (this.context.pop(), (this.exprAllowed = this.curContext() === u))
            : (this.exprAllowed = !0);
        }),
  ...
  Object.defineProperty(Ge.exports, 'tokTypes', {
    get: function () {
          ...
          switch (x) {
            ...
            case 123:
              return this.pos === this.start
                ...
                : ((h += this.input.slice(m, this.pos)), this.finishToken(n.jsxText, h));
            case 38:
...
`))
      ...
      jsx_readEntity() {
        ...
        for (; this.pos < this.input.length && m++ < 10; ) {
          if (((g = this.input[this.pos++]), g === ';')) {
            h[0] === '#'
              ? h[1] === 'x'
                ? ((h = h.substr(2)), os.test(h) && (x = String.fromCharCode(parseInt(h, 16))))
                : ((h = h.substr(1)), us.test(h) && (x = String.fromCharCode(parseInt(h, 10))))
              : (x = ns[h]);
            break;
          }
          h += g;
          ...
          case r.braceL:
            ...
            return (
              h.expression.type === 'JSXEmptyExpression' &&
                this.raise(h.start, 'JSX attributes must only be assigned a non-empty expression'),
              h
            );
          case n.jsxTagStart:
          case r.string:
      ...
      jsx_parseExpressionContainer() {
        ...
        return (
          this.next(),
          (h.expression =
            this.type === r.braceR ? this.jsx_parseEmptyExpression() : this.parseExpression()),
      ...
      jsx_parseElementAt(h, m) {
        ...
        if (!w.selfClosing) {
          ...
          ne(he.name) !== ne(w.name) &&
            this.raise(he.start, 'Expected corresponding JSX closing tag for <' + ne(w.name) + '>');
        }
...
var a = {
    ...
    relational: P('</>/<=/>=', 7),
    bitShift: P('<</>>/>>>', 8),
    plusMin: new S('+/-', { beforeExpr: !0, binop: 9, prefix: !0, startsExpr: !0 }),
    modulo: P('%', 10),
    star: P('*', 10),
    slash: P('/', 10),
...
var le = 0,
  ...
  T = function (t, i, s) {
    (this.options = t = Ni(t)),
      ...
      (this.keywords = K(_i[t.ecmaVersion >= 6 ? 6 : t.sourceType === 'module' ? '5module' : 5]));
    var r = '';
    t.allowReserved !== !0 &&
      ((r = Ae[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
      t.sourceType === 'module' && (r += ' await')),
      (this.reservedWords = K(r));
    var n = (r ? r + ' ' : '') + Ae.strict;
    (this.reservedWordsStrict = K(n)),
      (this.reservedWordsStrictBind = K(n + ' ' + Ae.strictBind)),
      (this.input = String(i)),
      (this.containsEsc = !1),
      s
        ? ((this.pos = s),
  ...
  for (;;) {
    ...
    if ((t[1] || t[2]) === 'use strict') {
      ...
      return (
        ...
        r === '}' ||
        (L.test(i[0]) &&
          !(/[(`.[+\-/*%<>=,?^&]/.test(r) || (r === '!' && this.input.charAt(s + 1) === '=')))
      );
    }
    (e += t[0].length),
      (N.lastIndex = e),
...
l.isLet = function (e) {
  ...
  if (M(s, !0)) {
    for (var r = i + 1; H((s = this.input.charCodeAt(r)), !0); ) ++r;
...
l.isAsyncFunction = function () {
  ...
  return (
    ...
    (t + 8 === this.input.length ||
      !(H((i = this.input.charCodeAt(t + 8))) || (i > 55295 && i < 56320)))
  );
};
l.parseStatement = function (e, t, i) {
  ...
  switch ((this.isLet(e) && ((s = a._var), (n = 'let')), s)) {
    ...
    case a._var:
      return (
        (n = n || this.value), e && n !== 'var' && this.unexpected(), this.parseVarStatement(r, n)
      );
    case a._while:
    ...
    default:
      ...
      return s === a.name && f.type === 'Identifier' && this.eat(a.colon)
        ? this.parseLabeledStatement(r, d, f, e)
...
l.parseForStatement = function (e) {
  ...
  var t =
    this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual('await')
      ? this.lastTokStart
      : -1;
  if ((this.labels.push(Ue), this.enterScope(0), this.expect(a.parenL), this.type === a.semi))
  ...
  if (this.type === a._var || this.type === a._const || i) {
    ...
    return (
      ...
      (this.type === a._in || (this.options.ecmaVersion >= 6 && this.isContextual('of'))) &&
      s.declarations.length === 1
        ? (this.options.ecmaVersion >= 9 &&
            (this.type === a._in ? t > -1 && this.unexpected(t) : (e.await = t > -1)),
          this.parseForIn(e, s))
  ...
  var n = this.isContextual('let'),
    ...
    p = new ye(),
    d = this.start,
    f = t > -1 ? this.parseExprSubscripts(p, 'await') : this.parseExpression(!0, p);
  return this.type === a._in || (o = this.options.ecmaVersion >= 6 && this.isContextual('of'))
    ? (t > -1
        ? (this.type === a._in && this.unexpected(t), (e.await = !0))
        : o &&
          this.options.ecmaVersion >= 8 &&
          (f.start === d && !u && f.type === 'Identifier' && f.name === 'async'
            ? this.unexpected()
            : this.options.ecmaVersion >= 9 && (e.await = !1)),
      n &&
        o &&
        this.raise(f.start, "The left-hand side of a for-of loop may not start with 'let'."),
      this.toAssignable(f, !1, p),
      this.checkLValPattern(f),
      this.parseForIn(e, f))
    : (this.checkExpressionErrors(p, !0), t > -1 && this.unexpected(t), this.parseFor(e, f));
};
l.parseFunctionStatement = function (e, t, i) {
  return this.next(), this.parseFunction(e, te | (i ? 0 : Le), !1, t);
};
...
l.parseCatchClauseParam = function () {
  var e = this.parseBindingAtom(),
    t = e.type === 'Identifier';
  return (
    this.enterScope(t ? dt : 0), this.checkLValPattern(e, t ? yt : G), this.expect(a.parenR), e
  );
};
...
l.parseLabeledStatement = function (e, t, i, s) {
  ...
  for (
    var u = this.type.isLoop ? 'loop' : this.type === a._switch ? 'switch' : null,
...
l.parseVarId = function (e, t) {
  (e.id = this.parseBindingAtom()), this.checkLValPattern(e.id, t === 'var' ? Me : G, !1);
};
var te = 1,
  Le = 2,
  vt = 4;
l.parseFunction = function (e, t, i, s, r) {
  this.initFunction(e),
    (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !s)) &&
      (this.type === a.star && t & Le && this.unexpected(), (e.generator = this.eat(a.star))),
    ...
    t & te &&
      ...
      e.id &&
        ...
        this.checkLValSimple(
          e.id,
          this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? Me : G) : xt
        ));
  var n = this.yieldPos,
    o = this.awaitPos,
  ...
  return (
    ...
    this.enterScope(je(e.async, e.generator)),
    t & te || (e.id = this.type === a.name ? this.parseIdent() : null),
    this.parseFunctionParams(e),
    this.parseFunctionBody(e, i, !1, r),
    (this.yieldPos = n),
    (this.awaitPos = o),
    (this.awaitIdentPos = u),
    this.finishNode(e, t & te ? 'FunctionDeclaration' : 'FunctionExpression')
  );
};
  ...
  for (r.body = [], this.expect(a.braceL); this.type !== a.braceR; ) {
    ...
    o &&
      ...
      o.type === 'MethodDefinition' && o.kind === 'constructor'
        ? (n && this.raiseRecoverable(o.start, 'Duplicate constructor in the same class'), (n = !0))
        : o.key &&
...
l.parseClassElement = function (e) {
  ...
  if (
    ...
    var d = !i.static && fe(i, 'constructor'),
      f = d && e;
    d && o !== 'method' && this.raise(i.key.start, "Constructor can't have get/set modifier"),
...
l.parseClassId = function (e, t) {
  this.type === a.name
    ? ((e.id = this.parseIdent()), t && this.checkLValSimple(e.id, G, !1))
...
l.parseExportDefaultDeclaration = function () {
  ...
  if (this.type === a._function || (e = this.isAsyncFunction())) {
    var t = this.startNode();
    return this.next(), e && this.next(), this.parseFunction(t, te | vt, !1, e);
...
l.parseWithClause = function () {
  ...
  for (var t = {}, i = !0; !this.eat(a.braceR); ) {
    ...
    Y(t, r) && this.raiseRecoverable(s.key.start, "Duplicate attribute key '" + r + "'"),
      (t[r] = !0),
      e.push(s);
  }
  return e;
...
l.parseModuleExportName = function () {
  if (this.options.ecmaVersion >= 13 && this.type === a.string) {
    ...
    return (
      Ii.test(e.value) && this.raise(e.start, 'An export name cannot include a lone surrogate.'), e
    );
  }
    ...
    case 'Identifier':
      this.strict &&
        ...
        s &&
          ...
          i &&
            (Y(i, e.name) && this.raiseRecoverable(e.start, 'Argument name clash'),
            (i[e.name] = !0)),
...
a.parenR.updateContext = a.braceR.updateContext = function () {
  ...
  e === _.b_stat && this.curContext().token === 'function' && (e = this.context.pop()),
    (this.exprAllowed = !e.isExpr);
};
a.braceL.updateContext = function (e) {
  this.context.push(this.braceIsBlock(e) ? _.b_stat : _.b_expr), (this.exprAllowed = !0);
};
...
a.backQuote.updateContext = function () {
  this.curContext() === _.q_tmpl ? this.context.pop() : this.context.push(_.q_tmpl),
    (this.exprAllowed = !1);
};
...
y.checkPropClash = function (e, t, i) {
  if (
    ...
    if (o) {
      var u;
      n === 'init' ? (u = (this.strict && o.init) || o.get || o.set) : (u = o.init || o[n]),
  ...
  switch (this.type) {
    ...
    case a.name:
      ...
      if (
        ...
        return (
          this.overrideContext(_.f_expr), this.parseFunction(this.startNodeAt(n, o), 0, !1, !0, t)
        );
      if (r && !this.canInsertSemicolon()) {
        if (this.eat(a.arrow)) return this.parseArrowExpression(this.startNodeAt(n, o), [p], !1, t);
        if (
          this.options.ecmaVersion >= 8 &&
          p.name === 'async' &&
          this.type === a.name &&
    ...
    case a.regexp:
      var d = this.value;
      return (
        (s = this.parseLiteral(d.value)), (s.regex = { pattern: d.pattern, flags: d.flags }), s
      );
    case a.num:
    case a.string:
...
y.parseExprImport = function (e) {
  ...
  if (this.type === a.dot) {
    ...
    return (
      (i.name = 'import'), (t.meta = this.finishNode(i, 'Identifier')), this.parseImportMeta(t)
    );
      ...
      : (this.expect(a.comma),
        this.afterTrailingComma(a.parenR)
          ...
          : ((e.options = this.parseMaybeAssign()),
            this.eat(a.parenR) ||
              (this.expect(a.comma), this.afterTrailingComma(a.parenR) || this.unexpected())));
...
y.parseParenAndDistinguishExpression = function (e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    ...
    if ((this.expect(a.parenR), e && this.shouldParseArrow(p) && this.eat(a.arrow)))
      return (
        this.checkPatternErrors(C, !1),
        this.checkYieldAwaitInDefaultParams(),
        (this.yieldPos = B),
...
y.parseObj = function (e, t) {
  ...
  for (i.properties = [], this.next(); !this.eat(a.braceR); ) {
    if (s) s = !1;
      ...
      (this.expect(a.comma), this.options.ecmaVersion >= 5 && this.afterTrailingComma(a.braceR))
    )
      break;
...
var j = function (t) {
  (this.parser = t),
    ...
    (this.unicodeProperties = Vt[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
    (this.source = ''),
    (this.flags = ''),
    (this.start = 0),
    (this.switchU = !1),
...
c.regexp_disjunction = function (e) {
  ...
  for (t && (e.branchID = new me(e.branchID, null)), this.regexp_alternative(e); e.eat(124); )
...
c.regexp_eatRegExpIdentifierName = function (e) {
  if (((e.lastStringValue = ''), this.regexp_eatRegExpIdentifierStart(e))) {
    for (e.lastStringValue += U(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e); )
...
c.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
  ...
  if (e.eat(117)) {
    ...
    if (s && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && Yi(e.lastIntValue))
      return !0;
...
c.regexp_eatCharacterClassEscape = function (e) {
  ...
  if (e.switchU && this.options.ecmaVersion >= 9 && ((i = t === 80) || t === 112)) {
    ...
    if (e.eat(123) && (s = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125))
      return i && s === V && e.raise('Invalid property name'), s;
...
function ts(e) {
  return (
    e === 40 || e === 41 || e === 45 || e === 47 || (e >= 91 && e <= 93) || (e >= 123 && e <= 125)
  );
}
    ...
    s === 92
      ...
      : s === 8232 || s === 8233
        ? (this.options.ecmaVersion < 10 && this.raise(this.start, 'Unterminated string constant'),
          ++this.pos,
          this.options.locations && (this.curLine++, (this.lineStart = this.pos)))
        : (Q(s) && this.raise(this.start, 'Unterminated string constant'), ++this.pos);
  }
  ...
  if (
    ...
    for (let n = e.comments.length - 2; n >= 0; n--) {
      ...
      J(o) === O(r) &&
        ...
        Ke(o) &&
        Ke(r) &&
        (e.comments.splice(n + 1, 1), (o.value += '*//*' + r.value), (o.range = [O(o), J(r)])),
        (r = o);
    }
  }
...
var Cs = (e, t, i, s) => {
    if (!(e && t == null))
      return t.replaceAll ? t.replaceAll(i, s) : i.global ? t.replace(i, s) : t.split(i).join(s);
  },
  ee = Cs;
var _s = /\*\/$/,
  Ts = /^\/\*\*?/,
...
function ii(e) {
  let t = `
`;
  e = ee(!1, e.replace(Ts, '').replace(_s, ''), As, '$1');
  let i = '';
  for (; i !== e; ) (i = e), (e = ee(!1, e, ws, `${t}$1 $2${t}`));
  e = e.replace($t, '').trimEnd();
  let s = Object.create(null),
    r = ee(!1, e, ei, '').replace($t, '').trimEnd(),
    n;
  for (; (n = ei.exec(e)); ) {
    let o = ee(!1, n[2], Es, '');
...
He.prototype = {
  ...
  translate(e, t) {
    ...
    if (i === s.name)
      (e.type = E.Identifier),
        ...
        t.ecmaVersion > 5 && (e.value === 'yield' || e.value === 'let') && (e.type = E.Keyword);
  ...
  onToken(e, t) {
    ...
    if (e.type === i.backQuote) {
      this._curlyBrace && (s.push(this.translate(this._curlyBrace, t)), (this._curlyBrace = null)),
        r.push(e),
        r.length > 1 && n();
      return;
    }
...
var Ye = () => e => {
  ...
  return (
    ...
    class extends e {
      ...
      parseTopLevel(s) {
        return this[z].impliedStrict && (this.strict = !0), super.parseTopLevel(s);
      }
      raise(s, r) {
...
function Xs(e, t = {}) {
  let i = ke(t),
    s = (i ? [i] : ['module', 'script']).map(n => () => li(e, { ...Ks, sourceType: n })),
    r;
  try {
    r = Se(s);
  } catch ({ errors: [n] }) {
