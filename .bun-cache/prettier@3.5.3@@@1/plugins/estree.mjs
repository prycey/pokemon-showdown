...
function Vs(e, { getVisitorKeys: t, predicate: r }) {
  for (let n of za(e, { getVisitorKeys: t })) if (r(n)) return !0;
  return !1;
}
var $s = () =>
...
var R = Do;
var fo = R(['Block', 'CommentBlock', 'MultiLine']),
  ee = fo;
var Eo = R([
    'AnyTypeAnnotation',
    'ThisTypeAnnotation',
...
var wr = R([
  ...
  To = R(['Identifier', 'ThisExpression', 'Super', 'PrivateName', 'PrivateIdentifier']),
...
function It(e, t) {
  ...
  if (r.length === 1) {
    ...
    return r[2] && !Fe(r[2])
      ? !1
      : (r.length === 2 ? Rt(r[1]) : xo(r[1]) && z(r[1]).length <= 1) || On(r[1]);
  return !1;
}
var yu = e => t => (
...
function Du(e, t) {
  ...
  for (let n in e) {
    let s = e[n];
    if (
      (s && typeof s == 'object' && typeof s.type == 'string' && (r++, (r += Du(s, t - r))), r > t)
    )
      return r;
  }
  return r;
...
function Ie(e, t = 2) {
  ...
  if (wr(e) || To(e) || e.type === 'ArgumentPlaceholder') return !0;
...
`)
  ...
  return W(e)
    ...
    : (e.type === 'UnaryExpression' && Po.has(e.operator)) || e.type === 'UpdateExpression'
      ? Ie(e.argument, t)
      : !1;
}
function fe(e) {
  ...
  function s(u) {
    switch (Se(u)) {
      ...
      case me: {
        ...
        return (
          i ? ((i = i.map(n)), (a = i[0])) : (a = n(a)), t({ ...u, contents: a, expandedStates: i })
        );
      }
      case $e:
      case Ve:
...
var je = { type: We },
  Ee = { type: _e };
var Yn = { type: ie, hard: !0 },
  Jo = { type: ie, hard: !0, literal: !0 },
  x = { type: ie },
  E = { type: ie, soft: !0 },
  F = [Yn, Ee],
  Rr = [Jo, Ee],
...
function le(e, t) {
  (t.leading = !0), (t.trailing = !1), Xn(e, t);
}
function Me(e, t, r) {
  (t.leading = !1), (t.trailing = !1), r && (t.marker = r), Xn(e, t);
}
function V(e, t) {
  (t.leading = !1), (t.trailing = !0), Xn(e, t);
}
function Go(e, t) {
  let r = null,
    n = t;
...
var Wr = Xo;
function Ho(e) {
  return [Wu, vu, Ru, ip, Qo, Vn, $n, _u, ju, cp, op, Qn, qu, lp, Mu, Ju, Kn, zo, Ap].some(t =>
    t(e)
  );
}
function Vo(e) {
...
function np({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
  return be(n, k(e)) !== '(' ? !1 : t && rp.has(r == null ? void 0 : r.type) ? (V(t, e), !0) : !1;
}
...
function Dp({ comment: e, enclosingNode: t, followingNode: r }) {
  return mp.has(t == null ? void 0 : t.type) && r && (yp.has(r.type) || ee(e))
    ? (le(r, e), !0)
    : !1;
}
...
function Cp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
  return we(t) && (((r.type === 'TSArrayType' || r.type === 'ArrayTypeAnnotation') && !n) || Nt(r))
    ? (V(M(!1, t.types, -1), e), !0)
    : !1;
}
...
var Pe = Symbol('MODE_BREAK'),
  at = Symbol('MODE_FLAT'),
  Yt = Symbol('cursor'),
  es = Symbol('DOC_FILL_PRINTED_LENGTH');
function Uu() {
  ...
  return t === Number.NEGATIVE_INFINITY
    ...
    : t < 0
      ...
      : t
        ? t.type === 'root'
          ? { ...e, root: e }
          : ts(e, { type: typeof t == 'string' ? 'stringAlign' : 'numberAlign', n: t }, r)
        : e;
}
function ts(e, t, r) {
          ...
          case Pe:
            ...
            c.literal
              ? m.root
                ...
                : (a.push(s), (u = 0))
              : ((u -= rs(a)), a.push(s + m.value), (u = m.length));
            break;
        }
        break;
      case ge:
  ...
  if (s.length > 1 || s.some(u => u.length > 0)) {
    ...
    let i = [],
      a = u.map(
        m =>
          '${' +
          ns(m, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: 'lf' }).formatted +
          '}'
      ),
...
function Ur(e, t) {
  return yt(e, r => (typeof r == 'string' ? (t ? Y(!1, r, /(\\*)`/gu, '$1$1\\`') : ss(r)) : r));
}
function ss(e) {
...
function vp({ node: e, parent: t, grandparent: r }) {
  return (
    (r &&
      ...
      r.openingElement.attributes.some(n => n.type === 'JSXAttribute' && n.name.name === 'jsx')) ||
...
`),
    ...
    let g = null;
    S ? (g = qp(m)) : (g = await e(D, { parser: 'graphql' })),
      g
...
async function Hp(e, t, r) {
  let { node: n } = r,
    s = Y(!1, n.quasis[0].value.raw, /((?:\\\\)*)\\`/gu, (o, p) => '\\'.repeat(p.length / 2) + '`'),
    u = Vp(s),
    i = u !== '';
...
function ci(e) {
  let t = `
`;
  e = Y(!1, e.replace(ec, '').replace(Zp, ''), nc, '$1');
  let r = '';
  for (; r !== e; ) (r = e), (e = Y(!1, e, rc, `${t}$1 $2${t}`));
...
function yi(e) {
  let { shebang: t, text: r, pragmas: n, comments: s } = uc(e),
    u = pi(r),
...
function os(e, t) {
  ...
  if (t.__isInHtmlInterpolation && !t.bracketSpacing && cc(r) && yr(e)) return !0;
  if (ac(r)) return !1;
  ...
  switch (r.type) {
    ...
    case 'BinaryExpression':
      if (s.type === 'UpdateExpression' || (r.operator === 'in' && oc(e))) return !0;
...
function fi(e, t) {
  ...
  return r.type === 'FunctionExpression' || r.type === 'ClassExpression'
    ? n.type === 'ExportDefaultDeclaration' || !os(e, t)
    : !Jt(r) || (n.type !== 'ExportDefaultDeclaration' && os(e, t))
      ? !1
      : e.call(() => fi(e, t), ...Lr(r));
}
function lc(e) {
...
function ps(e) {
  return e.type === 'Identifier'
    ? !0
    : W(e)
      ? !e.computed && !e.optional && e.property.type === 'Identifier' && ps(e.object)
      : !1;
}
function mc(e) {
  return (
    e.type === 'ChainExpression' && (e = e.expression),
    ps(e) || (L(e) && !e.optional && ps(e.callee))
  );
}
var ke = os;
function yc(e, t) {
...
function Ec(e, t, r) {
  ...
  if (
    ...
    let y = Ei(i, a(n));
    return { doc: Un([F, y ? F : '', s]), isBlock: o, hasLineSuffix: !0 };
  }
  return !o || (r != null && r.hasLineSuffix)
    ? { doc: [Un([' ', s]), Ee], isBlock: o, hasLineSuffix: !0 }
    : { doc: [' ', s], isBlock: o, hasLineSuffix: !1 };
}
function J(e, t, r = {}) {
  let { node: n } = e;
  if (!O(n == null ? void 0 : n.comments)) return '';
  let { indent: s = !1, marker: u, filter: i = Dc } = r,
    a = [];
  if (
    (e.each(({ node: p }) => {
...
function Fc(e, t, r) {
  ...
  let i = n.children.some(X),
    ...
    m = y ? x : B([D, E], ' '),
    C =
      ((v = (_ = n.openingElement) == null ? void 0 : _.name) == null ? void 0 : v.name) === 'fbt',
    c = Cc(e, t, r, m, C),
  ...
  for (; c.length > 0 && fs(M(!1, c, -1)); ) c.pop();
...
function Es(e, t, r, n, s) {
  ...
  ar(u.operator, u.left.operator)
    ? (i = e.call(g => Es(g, t, r, !0, s), 'left'))
    : i.push(l(t('left')));
  let a = Ht(u),
    o =
      (u.operator === '|>' || u.type === 'NGPipeExpression' || vc(e, r)) &&
...
function qc(e) {
  ...
  let [t, r] = e;
  return t.type === 'ModuleExpression' && Gc(r)
    ? !0
    : !T(t) &&
...
function Ii(e) {
  ...
  return mt(e) && pe(e).length > 1 ? !1 : De(e) ? Ie(e.left, 1) && Ie(e.right, 1) : Rn(e) || Ie(e);
}
function Wc(e) {
  ...
  let n = r('object'),
    ...
    o =
      ...
      ((a.type === 'AssignmentExpression' || a.type === 'VariableDeclarator') &&
        (Uc(u.object) || ((p = n.label) == null ? void 0 : p.memberChain)));
    ...
    if (L(w) && (Tt(w.callee) || L(w.callee))) {
      ...
      Tt(w)
        ? (u.unshift({
            node: w,
            needsParens: ke(e, t),
            printed: ye(e, W(w) ? As(e, t, r) : Kr(e, t, r), t),
          }),
          e.call(a, 'object'))
...
function Qr(e, t, r) {
  ...
  if (
    ...
    !s &&
    Tt(n.callee) &&
    !e.call(D => ke(D, t), 'callee', ...(n.callee.type === 'ChainExpression' ? ['expression'] : []))
  )
    return Oi(e, t, r);
...
function Ji(e, t, r, n = !1) {
  ...
  if (L(s)) {
    ...
    let o = pe(s);
    return !(o.length === 0 || (o.length === 1 && ir(o[0], t))) || tl(s, r)
      ? !1
      : e.call(u, 'callee');
  }
...
var il = R(['VoidTypeAnnotation', 'TSVoidKeyword', 'NullLiteralTypeAnnotation', 'TSNullKeyword']),
  al = R(['ObjectTypeAnnotation', 'TSTypeLiteral', 'GenericTypeAnnotation', 'TSTypeReference']);
function ol(e) {
  let { types: t } = e;
  if (t.some(n => T(n))) return !1;
  let r = t.find(n => al(n));
  return r ? t.every(n => n === r || il(n)) : !1;
}
function xs(e) {
  return qt(e) || Re(e) ? !0 : we(e) ? ol(e) : !1;
}
function Wi(e, t, r) {
  let n = t.semi ? ';' : '',
    { node: s } = e,
...
function H(e, t, r = 'typeAnnotation') {
  ...
  if (n.type === 'TSTypeAnnotation' || n.type === 'TypeAnnotation') {
    let u = e.call(Ni, r);
    (u === '=>' || (u === ':' && T(n, h.Leading))) && (s = !0), cl.add(n);
  }
  return s ? [' ', t(r)] : t(r);
}
var Ni = e =>
...
function K(e) {
  let { node: t } = e;
  return t.declare || (ll.has(t.type) && e.parent.type !== 'DeclareExportDeclaration')
    ? 'declare '
    : '';
}
var ml = new Set([
...
function Kt(e, t, r) {
  ...
  if (o.length === 0) s.push(yl(e, t, u, i));
    ...
    s.push(
      l([u, f([E, c ? fl(e, t, r, A) : [Dl(e, t, a, n.inexact, r), A], J(e, t)]), E, i], {
        shouldBreak: C,
        id: m,
      })
    );
...
function Ft(e, t, r) {
  ...
  return Yi(n, t) && (t.quoteProps === 'as-needed' || (t.quoteProps === 'consistent' && !Dn.get(s)))
...
function Ki(e) {
  return (
    gs.has(e) ||
      gs.set(e, e.type === 'ConditionalExpression' && !ae(e, t => t.type === 'ObjectExpression')),
    gs.get(e)
  );
}
...
function zi(e, t, r, n = {}) {
  ...
  let y = !Le(t.originalText, p) && (Qi(p) || gl(p, u, t) || (!a && Ki(p))),
    D = e.key === 'callee' && mt(e.parent),
    m = Symbol('arrow-chain'),
    C = Sl(e, n, { signatureDocs: s, shouldBreak: a }),
    c = !1,
    A = !1,
    d = !1;
  return (
    ...
    (u = Bl(e, t, n, { bodyDoc: u, bodyComments: i, functionBody: p, shouldPutBodyOnSameLine: y })),
    l([
...
function Ot(e, t, r, n) {
  ...
  if (
    s[n].length === 0 ||
    (!i && (u || (s[n].length === 1 && (s[n][0].type === 'NullableTypeAnnotation' || xs(s[n][0])))))
  )
    return ['<', b(', ', e.map(r, n)), wl(e, t), '>'];
...
function dn(e, t, r) {
  ...
  if (s.type === 'TSMappedType')
    return (
      s.readonly && u.push(Ss(s.readonly, 'readonly'), ' '),
      u.push('[', i),
...
function xn(e, t, r) {
  ...
  if ((n.id && i.push(' ', r('id')), i.push(r('typeParameters')), n.superClass)) {
    let y = [_l(e, t, r), r(n.superTypeArguments ? 'superTypeArguments' : 'superTypeParameters')],
...
function hn(e, t, r) {
  let { node: n } = e,
    s = [];
  return (
    O(n.decorators) && s.push(Fs(e, t, r)),
    s.push($t(n)),
...
function pa(e, t) {
  if (t.semi || Ps(e, t) || ks(e, t)) return !1;
  let { node: r, key: n, parent: s } = e;
  return !!(
...
function Ta(e, t) {
  return e.type !== 'ImportDeclaration' || O(e.specifiers) || e.importKind === 'type'
    ? !0
    : Is(t, q(e), q(e.source)).trimEnd().endsWith('from');
}
function Nl(e, t) {
  var n, s;
...
function xa(e, t, r) {
  ...
  return (
    s === 'ExportNamespaceSpecifier' || s === 'ImportNamespaceSpecifier'
      ...
      : o && (y = r(i)),
    p && !Gl(n) && (D = r(a)),
    [Ls(s === 'ImportSpecifier' ? n.importKind : n.exportKind, !1), y, y && D ? ' as ' : '', D]
  );
}
function Gl(e) {
...
function gt(e, t, r) {
  ...
  return e.match(I => I.type === 'ObjectPattern' && !O(I.decorators), Os) ||
    (Re(s) &&
      (e.match(
        void 0,
        ...
        e.match(void 0, (I, G) => I.type === 'FunctionTypeParam' && G === 'typeAnnotation', Os))) ||
    (!m &&
      e.match(
...
function Hl(e) {
  ...
  return n === t ? !1 : r[Xl.get(r.type)] === n;
}
function ha(e, t, r) {
  let { node: n } = e,
    s = n.type === 'ConditionalExpression',
...
function zt(e, t, r, n) {
  ...
  let Js = Symbol('test'),
    ...
    Ua = u
      ? [_s(r('test')), s.test.type === 'ConditionalExpression' ? Ee : '']
      : [
          r('checkType'),
          ' ',
          'extends',
    ...
    Ln = r(o),
    Ws = pt ? B(Ln, Jr(_s(Ln)), { groupId: Tr }) : Ln,
    tr = [
      Xa,
  ...
  switch (s.type) {
    ...
    case 'VariableDeclaration': {
      let a = e.map(r, 'declarations'),
        o = e.parent,
        p = o.type === 'ForStatement' || o.type === 'ForInStatement' || o.type === 'ForOfStatement',
        y = s.declarations.some(m => m.init),
        D;
      return (
        a.length === 1 && !T(s.declarations[0]) ? (D = a[0]) : a.length > 0 && (D = f(a[0])),
        (i = [K(e), s.kind, D ? [' ', D] : '', f(a.slice(1).map(m => [',', y && !p ? F : x, m]))]),
        (p && o.body !== s) || i.push(u),
        l(i)
      );
    }
    ...
    case 'ForStatement': {
      ...
      return !s.init && !s.test && !s.update
        ...
        : [
            p,
            l(['for (', l([f([E, r('init'), ';', x, r('test'), ';', x, r('update')]), E]), ')', a]),
          ];
    }
    case 'WhileStatement':
...
function Wa(e, t) {
  ...
  if (r === 'ObjectProperty') {
    ...
    n.type === 'Identifier'
      ...
      : n.type === 'NumericLiteral' && (t.key = { type: 'StringLiteral', value: String(n.value) });
    return;
  }
...
var St = 'JavaScript',
  ...
  Na = pm;
var cm = { estree: vs, 'estree-json': js },
  lm = [...Xs, ...Ma];
var lx = Ms;
