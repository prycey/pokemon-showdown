(function (f) {
  ...
  var pi = (t, e, r) =>
    e in t ? Et(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r);
  var an = (t, e) => {
    ...
    hi = (t, e, r, n) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let s of li(e))
          !ci.call(t, s) &&
            s !== r &&
            Et(t, s, { get: () => e[s], enumerable: !(n = ui(e, s)) || n.enumerable });
      return t;
    };
  var fi = t => hi(Et({}, '__esModule', { value: !0 }), t);
  var cr = (t, e, r) => pi(t, typeof e != 'symbol' ? e + '' : e, r),
    on = (t, e, r) => e.has(t) || sn('Cannot ' + r);
  var R = (t, e, r) => (on(t, e, 'read from private field'), r ? r.call(t) : e.get(t)),
    At = (t, e, r) =>
      e.has(t)
        ...
        : e instanceof WeakSet
          ? e.add(t)
          : e.set(t, r),
    un = (t, e, r, n) => (on(t, e, 'write to private field'), n ? n.call(t, r) : e.set(t, r), r);
  var jo = {};
  an(jo, { languages: () => Ts, options: () => ks, parsers: () => en, printers: () => Yo });
  var mi = (t, e, r, n) => {
      if (!(t && e == null))
  ...
  var ye = 'string',
    ...
    Xe = 'label',
    Be = 'break-parent',
    Dt = new Set([Ye, we, be, je, Te, xe, ce, ke, Ke, Qe, j, Xe, Be]);
  var di = (t, e, r) => {
      if (!(t && e == null))
  ...
  var Le = gi;
  var Ci = t => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(t);
  function Si(t) {
    let e = t === null ? 'null' : typeof t;
    if (e !== 'string' && e !== 'object')
      return `Unexpected doc '${e}', 
Expected it to be 'string' or 'object'.`;
    if (Le(t)) throw new Error('doc is valid.');
...
`)
  ...
  var mr = () => {},
    ...
    cn = mr;
  function k(t) {
    return ne(t), { type: we, contents: t };
  }
  function pn(t, e) {
    return ne(e), { type: be, contents: e, n: t };
  }
  function E(t, e = {}) {
    return (
      ne(t),
  ...
  function hn(t) {
    return pn(Number.NEGATIVE_INFINITY, t);
  }
  function fn(t) {
    return pn({ type: 'root' }, t);
  }
  function vt(t) {
    return cn(t), { type: xe, parts: t };
  }
  function pe(t, e = '', r = {}) {
    return (
      ne(t), e !== '' && ne(e), { type: ce, breakContents: t, flatContents: e, groupId: r.groupId }
    );
  }
  function mn(t, e) {
    return ne(t), { type: ke, contents: t, groupId: e.groupId, negate: e.negate };
  }
  var se = { type: Be };
  var Ei = { type: j, hard: !0 },
    Ai = { type: j, hard: !0, literal: !0 },
    _ = { type: j },
    v = { type: j, soft: !0 },
    S = [Ei, se],
    ln = [Ai, se];
...
`,
  ...
  var bi = new Set([
    ...
    Ti = new Set(['if', 'else if', 'for', 'switch', 'case']);
  function _n(t, e) {
    var r;
    if (
      t.type === 'text' ||
  ...
  function ki(t, e, r, n) {
    ...
    return /^\s*$/u.test(i)
      ? ''
      : T(i, t, { parser: '__ng_directive', __isInHtmlAttribute: !1 }, Q);
  }
  var Dn = ki;
  var Bi = t => String(t).split(/[/\\]/u).pop();
  function vn(t, e) {
    if (!e) return;
  ...
  function Fi(t, e) {
    let r = t.plugins.flatMap(s => s.languages ?? []),
      n = Li(r, e.language) ?? vn(r, e.physicalFile) ?? vn(r, e.file) ?? (e.physicalFile, void 0);
  ...
  var Pi = t => w(!1, t, /^[\t\f\r ]*\n/gu, ''),
    ...
    xn = t => {
      ...
      return (
        n && (e = e.slice(0, -n.length)), { leadingWhitespace: r, trailingWhitespace: n, text: e }
      );
    };
  function wt(t, e) {
    return !!(
      ...
      (me(t) && t.children.some(r => r.type !== 'text' && r.type !== 'interpolation')) ||
      (xt(t, e) && !W(t) && t.type !== 'interpolation')
    );
  }
  function de(t) {
    return t.type === 'attribute' || !t.parent || !t.prev ? !1 : Ii(t.prev);
  }
  function Ii(t) {
  ...
  function kn(t) {
    return t.children && !W(t);
  }
  function Bn(t) {
    return W(t) || t.type === 'interpolation' || Er(t);
  }
  function Er(t) {
    return Hn(t).startsWith('pre');
  }
  function Ln(t, e) {
    var s, i;
    let r = n();
    ...
    return r;
    function n() {
      return Fe(t) || t.type === 'angularControlFlowBlock'
        ? !1
              ...
              : !(
                  (!t.prev &&
                    (t.parent.type === 'root' ||
                      ...
                      W(t.parent) ||
                      et(t.parent, e) ||
                      !Hi(t.parent.cssDisplay))) ||
                  (t.prev && !Wi(t.prev.cssDisplay))
                );
    }
  }
  function Fn(t, e) {
            ...
            : !(
                (!t.next &&
                  (t.parent.type === 'root' ||
                    ...
                    W(t.parent) ||
                    et(t.parent, e) ||
                    !Vi(t.parent.cssDisplay))) ||
                (t.next && !Ui(t.next.cssDisplay))
              );
  }
  function Nn(t) {
    return zi(t.cssDisplay) && !W(t);
  }
  function Je(t) {
    return (
      Fe(t) ||
  ...
  function Pn(t) {
    return (
      ...
      (t.type === 'element' &&
        t.children.length > 0 &&
        (['body', 'script', 'style'].includes(t.name) || t.children.some(e => $i(e)))) ||
      (t.firstChild &&
        t.firstChild === t.lastChild &&
        t.firstChild.type !== 'text' &&
        Rn(t.firstChild) &&
        (!t.lastChild.isTrailingSpaceSensitive || $n(t.lastChild)))
    );
  }
  function Ar(t) {
    return (
  ...
  function bt(t) {
    return On(t) || (t.prev && Ri(t.prev)) || In(t);
  }
  function Ri(t) {
    return On(t) || (t.type === 'element' && t.fullName === 'br') || In(t);
  }
  function In(t) {
    return Rn(t) && $n(t);
  }
  function Rn(t) {
    return (
      ...
      (t.prev
        ...
        : t.parent.type === 'root' || t.parent.startSourceSpan.end.line < t.sourceSpan.start.line)
    );
  }
  function $n(t) {
    return (
  ...
  function Oi(t, e) {
    ...
    return !i && !s ? 'babel' : (Ne(e, { language: i }) ?? Mn(s));
  }
  function Mi(t, e) {
    if (!xt(t, e)) return;
    let { attrMap: r } = t;
  ...
  function qn(t, e) {
    ...
    if (t.type === 'element' && t.namespace === 'svg')
      if (Gi(t, s => s.fullName === 'svg:foreignObject')) r = !0;
    ...
    switch (e.htmlWhitespaceSensitivity) {
      ...
      case 'ignore':
        return 'block';
      default:
        return (t.type === 'element' && (!t.namespace || r || fe(t)) && wn[t.name]) || yn;
    }
  }
  function Hn(t) {
    return (t.type === 'element' && (!t.namespace || fe(t)) && Tn[t.name]) || bn;
  }
  function Yi(t) {
...
`);
  ...
  var ji = new Set(['template', 'style', 'script']);
  function et(t, e) {
    return ge(t, e) && !ji.has(t.fullName);
  }
  function ge(t, e) {
    return (
      e.parser === 'vue' &&
  ...
  function xt(t, e) {
    return ge(t, e) && (et(t, e) || (t.attrMap.lang && t.attrMap.lang !== 'html'));
  }
  function Vn(t) {
    let e = t.fullName;
  ...
  function Bt(t, e) {
    return ge(t, e) && t.name === 'script';
  }
  var wr = /\{\{(.+?)\}\}/su;
  async function Wn(t, e) {
    let r = [];
    for (let [n, s] of t.split(wr).entries())
      if (n % 2 === 0) r.push(B(s));
      else
        try {
          r.push(
            E([
              '{{',
              k([_, await T(s, e, { parser: '__ng_interpolation', __isInHtmlInterpolation: !0 })]),
              _,
              '}}',
            ])
          );
  ...
  function br({ parser: t }) {
    return (e, r, n) => T(N(n.node), e, { parser: t }, Q);
  }
  var Ki = br({ parser: '__ng_action' }),
    Qi = br({ parser: '__ng_binding' }),
    Xi = br({ parser: '__ng_directive' });
  function Ji(t, e) {
    if (e.parser !== 'angular') return;
    let { node: r } = t,
      n = r.fullName;
    if ((n.startsWith('(') && n.endsWith(')')) || n.startsWith('on-')) return Ki;
    if (
      ...
      return Qi;
    if (n.startsWith('*')) return Xi;
    let s = N(r);
    if (/^i18n(?:-.+)?$/u.test(n)) return () => he(vt(kt(r, s.trim())), !s.includes('@@'));
    if (wr.test(s)) return i => Wn(s, i);
  }
  var zn = Ji;
  function Zi(t, e) {
    let { node: r } = t,
...
` ||
  ...
  function ia(t) {
    ...
    for (;;) {
      ...
      (u = o), (r = p(ra)), (n = []), r.slice(-1) === ',' ? ((r = r.replace(na, '')), d()) : f();
    }
    function f() {
      for (p(ea), s = '', i = 'in descriptor'; ; ) {
        if (((a = t.charAt(o)), i === 'in descriptor'))
          if (Yn(a)) s && (n.push(s), (s = ''), (i = 'after descriptor'));
          else if (a === ',') {
            (o += 1), s && n.push(s), d();
            return;
        ...
        else if (i === 'after descriptor' && !Yn(a))
          if (a === '') {
            d();
            return;
  ...
  function ua(t) {
    let e = Kn(t),
      r = oa.filter(l => e.some(f => Object.prototype.hasOwnProperty.call(f, l)));
  ...
  function es(t, e, { parseWithTs: r }) {
    return T(`function _(${t}) {}`, e, { parser: r ? 'babel-ts' : 'babel', __isVueBindings: !0 });
  }
  async function ts(t, e, r, n) {
    let s = N(r.node),
      { left: i, operator: a, right: o } = ca(s),
      u = Pe(r, n);
    return [
      E(
  ...
  function pa(t, e) {
    ...
    let { node: r } = t,
      n = r.fullName;
    if (n === 'v-for') return ts;
    if (n === 'generic' && Bt(r.parent, e)) return Zn;
    let s = N(r),
      i = Pe(t, e);
    if (Vn(r) || Un(r, e)) return a => es(s, a, { parseWithTs: i });
    if (n.startsWith('@') || n.startsWith('v-on:')) return a => ha(s, a, { parseWithTs: i });
    if (n.startsWith(':') || n.startsWith('.') || n.startsWith('v-bind:'))
      return a => fa(s, a, { parseWithTs: i });
    if (n.startsWith('v-')) return a => rs(s, a, { parseWithTs: i });
  }
  async function ha(t, e, { parseWithTs: r }) {
    var n;
    try {
      return await rs(t, e, { parseWithTs: r });
    } catch (s) {
      if (((n = s.cause) == null ? void 0 : n.code) !== 'BABEL_PARSER_SYNTAX_ERROR') throw s;
    }
    return T(t, e, { parser: r ? '__vue_ts_event_binding' : '__vue_event_binding' }, Q);
  }
  function fa(t, e, { parseWithTs: r }) {
    return T(t, e, { parser: r ? '__vue_ts_expression' : '__vue_expression' }, Q);
  }
  function rs(t, e, { parseWithTs: r }) {
    return T(t, e, { parser: r ? '__ts_expression' : '__js_expression' }, Q);
  }
  var ns = pa;
  function ma(t, e) {
    let { node: r } = t;
  ...
  function da(t) {
    return async (e, r, n, s) => {
      ...
      if (i)
        return (
          (i = fr(i, a => (typeof a == 'string' ? w(!1, a, '"', '&quot;') : a))),
          [n.node.rawName, '="', E(i), '"']
        );
    };
  }
  var ss = ma;
  var is = new Proxy(() => {}, { get: () => is }),
    xr = is;
  function ga(t) {
  ...
  function tt(t, e) {
    return [t.isSelfClosing ? '' : Ca(t, e), Ce(t, e)];
  }
  function Ca(t, e) {
    return t.lastChild && Ee(t.lastChild) ? '' : [Sa(t, e), Lt(t, e)];
  }
  function Ce(t, e) {
    return (t.next ? X(t.next) : _e(t.parent)) ? '' : [Se(t, e), z(t, e)];
  }
  function Sa(t, e) {
    return _e(t) ? Se(t.lastChild, e) : '';
  }
  function z(t, e) {
    return Ee(t) ? Lt(t.parent, e) : rt(t) ? Ft(t.next, e) : '';
  }
  function Lt(t, e) {
    if ((xr.ok(!t.isSelfClosing), os(t, e))) return '';
    switch (t.type) {
      case 'ieConditionalComment':
        return '<!';
      case 'element':
  ...
  function os(t, e) {
    return !t.isSelfClosing && !t.endSourceSpan && (de(t) || wt(t.parent, e));
  }
  function X(t) {
    return (
      t.prev &&
  ...
  function Ea(t, e, r) {
    ...
    let s = ((f = n.prev) == null ? void 0 : f.type) === 'comment' && _a(n.prev.value),
      i =
        typeof s == 'boolean' ? () => s : Array.isArray(s) ? d => s.includes(d.rawName) : () => !1,
      a = t.map(({ node: d }) => (i(d) ? B(e.originalText.slice(J(d), Z(d))) : r()), 'attrs'),
      o =
        n.type === 'element' &&
        n.fullName === 'script' &&
        n.attrs.length === 1 &&
        ...
        n.children.length === 0,
      p = e.singleAttributePerLine && n.attrs.length > 1 && !ge(n, e) ? S : _,
      l = [k([o ? ' ' : _, H(p, a)])];
    return (
      (n.firstChild && nt(n.firstChild)) || (n.isSelfClosing && _e(n.parent)) || o
  ...
  function st(t, e, r) {
    let { node: n } = t;
    return [Ae(n, e), Ea(t, e, r), n.isSelfClosing ? '' : Aa(n)];
  }
  function Ae(t, e) {
    return t.prev && rt(t.prev) ? '' : [G(t, e), Ft(t, e)];
  }
  function G(t, e) {
    return nt(t) ? Nt(t.parent) : X(t) ? Se(t.prev, e) : '';
  }
  var as = '<!doctype';
  function Ft(t, e) {
    switch (t.type) {
      ...
      case 'docType': {
        if (t.value === 'html') {
          let n = e.filepath ?? '';
          if (/\.html?$/u.test(n)) return as;
        }
        return e.originalText.slice(J(t), Z(t)).slice(0, as.length);
      }
      case 'angularIcuExpression':
        return '{';
      case 'element':
  ...
  function Nt(t) {
    switch ((xr.ok(!t.isSelfClosing), t.type)) {
      case 'ieConditionalComment':
        return ']>';
      case 'element':
  ...
  function Da(t, e) {
    ...
    return (
      t.lastChild && Ee(t.lastChild)
        ? (n += Lt(t, e).length)
        : _e(t) && (n -= Se(t.lastChild, e).length),
      e.originalText.slice(r, n)
    );
  }
  var Pt = Da;
  var va = new Set(['if', 'else if', 'for', 'switch', 'case']);
  function ya(t, e) {
    let { node: r } = t;
    switch (r.type) {
      case 'element':
          ...
          return n
            ? async (s, i) => {
                let a = Pt(r, e),
                  ...
                  u = '';
                return (
                  o || ((u = await s(_r(a), { parser: n, __embeddedInHtml: !0 })), (o = u === '')),
                  [G(r, e), E(st(t, e, i)), o ? '' : S, u, o ? '' : S, tt(r, e), z(r, e)]
                );
              }
            : void 0;
        }
      ...
      case 'text':
        if (W(r.parent)) {
          ...
          if (n)
            return async s => {
              let i = n === 'markdown' ? vr(r.value.replace(/^[^\S\n]*\n/u, '')) : r.value,
          ...
          return async n => {
            ...
            return (
              e.parser === 'angular'
                ...
                : e.parser === 'vue'
                  ? (s.parser = Pe(t, e) ? '__vue_ts_expression' : '__vue_expression')
                  : (s.parser = '__js_expression'),
              [k([_, await n(r.value, s)]), r.parent.next && X(r.parent.next) ? ' ' : _]
            );
          };
        break;
      case 'attribute':
      ...
      case 'angularControlFlowBlockParameters':
        return va.has(t.parent.name) ? Dn : void 0;
  ...
  var wa = 10;
  for (let t = 0; t <= wa; t++) at();
  function kr(t) {
    return at(t);
  }
  function ba(t, e = 'type') {
    kr(t);
    function r(n) {
      let s = n[e],
        i = t[s];
...
` + t
  ...
  function ds(t) {
    let e = Z(t);
    return t.type === 'element' && !t.endSourceSpan && Ie(t.children)
      ? Math.max(e, ds(K(!1, t.children, -1)))
      : e;
  }
  function ot(t, e, r) {
    let n = t.node;
        ...
        B(
          O.trimEnd(
            e.originalText.slice(
              ...
              s - (n.next && X(n.next) ? Se(n, e).length : 0)
            )
          )
        ),
        z(n, e),
  ...
  function It(t, e) {
    return $(t) && $(e)
      ...
      : (rt(t) &&
          ...
          (t.type === 'element' && t.isSelfClosing && X(e))
        ? ''
  ...
  function Re(t, e, r) {
    ...
    return t.map((i, a) => {
      ...
      return (
        ...
        C && (Je(o) ? $(o.next) && f.push(S, S) : C === S ? $(o.next) && f.push(S) : l.push(C)),
        [...u, E([...p, E([ot(i, e, r), ...l], { id: s[a] })]), ...f]
      );
    }, 'children');
  }
  function gs(t, e, r) {
  ...
  function Cs(t) {
    ...
    return !(
      ...
      (r = ms.get(t.name)) != null &&
      r.has(t.next.name)
    );
  }
  function ka(t) {
    let { previous: e } = t;
    return (e == null ? void 0 : e.type) === 'angularControlFlowBlock' && !de(e) && !Cs(e);
  }
  function Ss(t, e, r) {
      ...
      E([
        k([
          ...
          t.map(({ node: s, isLast: i }) => {
            ...
            return (
              s.type === 'text' &&
                (s.hasLeadingSpaces && a.unshift(_), s.hasTrailingSpaces && !i && a.push(_)),
              a
            );
          }, 'expression'),
        ]),
  ...
  function As(t, e, r) {
    let { node: n } = t;
    if (wt(n, e)) return [G(n, e), E(st(t, e, r)), B(Pt(n, e)), ...tt(n, e), z(n, e)];
    let s =
        n.children.length === 1 &&
        (n.firstChild.type === 'interpolation' || n.firstChild.type === 'angularIcuExpression') &&
          ...
          : s
            ...
            : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive
              ...
              : (n.lastChild.type === 'comment' ||
                  ...
                  new RegExp(`\\n[\\t ]{${e.tabWidth * (t.ancestors.length - 1)}}$`, 'u').test(
                    n.lastChild.value
                  )
                ? ''
                : v;
  ...
  var Ba = /-+([a-z0-9])/g;
  function ys(t) {
    return t.replace(Ba, (...e) => e[1].toUpperCase());
  }
  var ie = class t {
      constructor(e, r, n, s) {
...
` && ++o == r
  ...
  var La = [Na, Pa, Ra, Oa, Ma, Va, qa, Ha, Ua, $a];
  function Fa(t, e) {
    for (let r of La) r(t, e);
    return t;
  }
  function Na(t) {
    t.walk(e => {
...
`
        ...
        for (let s of n.children) {
          ...
          for (let u = 0; u < o.length; u++, i = a) {
            ...
            if (u % 2 === 0) {
              (a = i.moveBy(p.length)),
                p.length > 0 &&
                  n.insertChildBefore(s, { type: 'text', value: p, sourceSpan: new h(i, a) });
              continue;
            }
            (a = i.moveBy(p.length + 4)),
              n.insertChildBefore(s, {
                ...
                children:
                  p.length === 0
                    ? []
                    : [{ type: 'text', value: p, sourceSpan: new h(i.moveBy(2), a.moveBy(-2)) }],
              });
          }
          n.removeChild(s);
        }
  ...
  function Ma(t) {
    t.walk(e => {
      ...
      if (
        r.length === 0 ||
        (r.length === 1 && r[0].type === 'text' && O.trim(r[0].value).length === 0)
      ) {
      ...
      if (!n)
        for (let i = 0; i < r.length; i++) {
          ...
          let { leadingWhitespace: o, text: u, trailingWhitespace: p } = xn(a.value),
            l = a.prev,
            f = a.next;
          u
            ? ((a.value = u),
              (a.sourceSpan = new h(
                a.sourceSpan.start.moveBy(o.length),
                a.sourceSpan.end.moveBy(-p.length)
              )),
              o && (l && (l.hasTrailingSpaces = !0), (a.hasLeadingSpaces = !0)),
              p && ((a.hasTrailingSpaces = !0), f && (f.hasLeadingSpaces = !0)))
            : (e.removeChild(a),
              i--,
              (o || p) && (l && (l.hasTrailingSpaces = !0), f && (f.hasLeadingSpaces = !0)));
        }
  ...
  function Ua(t, e) {
    t.walk(r => {
      ...
      if (n) {
        if (n.length === 0) {
          r.isDanglingSpaceSensitive = Nn(r);
          return;
        }
        for (let s of n)
          (s.isLeadingSpaceSensitive = Ln(s, e)), (s.isTrailingSpaceSensitive = Fn(s, e));
  ...
  function Wa(t, e, r) {
    ...
    switch (n.type) {
      ...
      case 'ieConditionalEndComment':
        return [Ae(n), Ce(n)];
      case 'interpolation':
        return [Ae(n, e), ...t.map(r, 'children'), Ce(n, e)];
      case 'text': {
      ...
      case 'docType':
        return [
          E([Ae(n, e), ' ', w(!1, n.value.replace(/^html\b/iu, 'html'), /\s+/gu, ' ')]),
          Ce(n, e),
        ];
      case 'comment':
  ...
  var xs = 'HTML',
    ...
    ks = Ga;
  var en = {};
  an(en, { angular: () => Wo, html: () => Uo, lwc: () => Go, vue: () => zo });
  var Np = new RegExp(
    `(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`,
    'g'
  );
  ...
  function Rr() {
    return (
      Ht ||
        ((Ht = {}),
        qt(ee.HTML, ['iframe|srcdoc', '*|innerHTML', '*|outerHTML']),
        qt(ee.STYLE, ['*|style']),
        qt(ee.URL, [
          '*|formAction',
          'area|href',
  ...
  var Ya = 'boolean',
    ...
    Ja = Array.from(Ps).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
    Ut = class extends Vt {
      constructor() {
        super(),
              ...
              if (l.length > 0)
                switch (l[0]) {
                  case '*':
                    ...
                    break;
                  case '!':
                    r.set(l.substring(1), Ya);
                    break;
                  case '#':
                    r.set(l.substring(1), ja);
                    break;
                  case '%':
      ...
      hasElement(e, r) {
        return r.some(n => n.name === Nr.name) ||
          (e.indexOf('-') > -1 && (Pr(e) || Ir(e) || r.some(n => n.name === Fr.name)))
          ? !0
    ...
    return (
      pt ||
        ...
        (pt = Object.assign(Object.create(null), {
          ...
          tbody: new m({ closedByChildren: ['tbody', 'tfoot'], closedByParent: !0 }),
          ...
          foreignObject: new m({ implicitNamespacePrefix: 'svg', preventNamespaceInheritance: !0 }),
          ...
          rb: new m({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
          rt: new m({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
          rtc: new m({ closedByChildren: ['rb', 'rtc', 'rp'], closedByParent: !0 }),
          rp: new m({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
          optgroup: new m({ closedByChildren: ['optgroup'], closedByParent: !0 }),
          option: new m({ closedByChildren: ['option', 'optgroup'], closedByParent: !0 }),
          pre: new m({ ignoreFirstLf: !0 }),
          listing: new m({ ignoreFirstLf: !0 }),
          style: new m({ contentType: P.RAW_TEXT }),
          script: new m({ contentType: P.RAW_TEXT }),
          title: new m({ contentType: { default: P.ESCAPABLE_RAW_TEXT, svg: P.PARSABLE_DATA } }),
          textarea: new m({ contentType: P.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 }),
        })),
        new Ut().allKnownElementNames().forEach(e => {
          !pt[e] && Me(e) === null && (pt[e] = new m({ canSelfClose: !1 }));
        })),
      pt[t] ?? Is
    );
  }
...
`,
  ...
  var $r = class t {
      static fromArray(e) {
        return e ? (Rs('interpolation', e), new t(e[0], e[1])) : Or;
      }
      constructor(e, r) {
  ...
  function Ks(t, e, r, n = {}) {
    let s = new Wr(new De(t, e), r, n);
    return s.tokenize(), new Ur(ko(s.tokens), s.errors, s.nonNormalizedIcuExpressions);
  }
  var Do = /\r\n?/g;
  function Ue(t) {
  ...
  var Ct = class {
    ...
    Wr = class {
      constructor(e, r, n) {
        ...
        (this._cursor = n.escapedString ? new zr(e, s) : new nr(e, s)),
...
`
      ...
      _getBlockName() {
        ...
        return (
          this._attemptCharCodeUntilFn(n => (ut(n) ? !e : Ws(n) ? ((e = !0), !1) : !0)),
      ...
      _consumeBlockParameters() {
        for (
          this._attemptCharCodeUntilFn(zs);
          ...
          this._endToken([this._cursor.getChars(e)]), this._attemptCharCodeUntilFn(zs);
        }
      }
      ...
      _consumeLetDeclarationValue() {
        ...
        for (this._beginToken(31, e); this._cursor.peek() !== 0; ) {
          ...
          Ot(r) &&
            (this._cursor.advance(),
            this._attemptCharCodeUntilFn(n => (n === 92 ? (this._cursor.advance(), !1) : n === r))),
            this._cursor.advance();
        }
      ...
      _tokenizeExpansionForm() {
        ...
        if (To(this._cursor.peek()) && this._isInExpansionForm())
      ...
      _attemptCharCodeCaseInsensitive(e) {
        return xo(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
      }
      _requireCharCode(e) {
        let r = this._cursor.clone();
      ...
      _consumeEntity(e) {
        ...
        if ((this._cursor.advance(), this._attemptCharCode(35))) {
          ...
          if ((this._attemptCharCodeUntilFn(wo), this._cursor.peek() != 59)) {
            this._cursor.advance();
            let a = n ? rr.HEX : rr.DEC;
            throw this._createError(vo(a, this._cursor.getChars(r)), this._cursor.getSpan());
          }
          ...
          try {
            ...
            throw this._createError(Hs(this._cursor.getChars(r)), this._cursor.getSpan());
          }
        } else {
          let n = this._cursor.clone();
          if ((this._attemptCharCodeUntilFn(bo), this._cursor.peek() != 59))
            this._beginToken(e, r), (this._cursor = n), this._endToken(['&']);
          else {
            let s = this._cursor.getChars(n);
            this._cursor.advance();
            let i = Ve[s];
            if (!i) throw this._createError(Hs(s), this._cursor.getSpan(r));
            this._endToken([i, `&${s};`]);
          }
        }
      }
      ...
      _consumePrefixAndName() {
        let e = this._cursor.clone(),
          r = '';
        for (; this._cursor.peek() !== 58 && !yo(this._cursor.peek()); ) this._cursor.advance();
        let n;
        this._cursor.peek() === 58
          ? ((r = this._cursor.getChars(e)), this._cursor.advance(), (n = this._cursor.clone()))
          : (n = e),
          this._requireCharCodeUntilFn(Vs, r === '' ? 0 : 1);
        let s = this._cursor.getChars(n);
        return [r, s];
      }
      _consumeTagOpen(e) {
        ...
        this._handleFullNameStackForTagOpen(n, r),
          a === P.RAW_TEXT
            ...
            : a === P.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, r, !0);
      }
      _consumeRawTextWithTagClose(e, r, n) {
        this._consumeRawText(n, () =>
          !this._attemptCharCode(60) ||
          !this._attemptCharCode(47) ||
          (this._attemptCharCodeUntilFn(b), !this._attemptStrCaseInsensitive(e ? `${e}:${r}` : r))
            ? !1
      ...
      _isBlockStart() {
        if (this._tokenizeBlocks && this._cursor.peek() === 64) {
          let e = this._cursor.clone();
          if ((e.advance(), Ws(e.peek()))) return !0;
        }
        return !1;
      }
      _readUntil(e) {
    ...
    sr = class {
      ...
      parse(e, r, n, s = !1, i) {
        let a =
          ...
          A = new Kr(f.tokens, o, d, C, s);
        return A.build(), new jr(A.rootNodes, f.errors.concat(A.errors));
      }
    },
    Kr = class t {
      constructor(e, r, n, s, i) {
      ...
      _consumeExpansion(e) {
        ...
        this._addToParent(new Gt(r.parts[0], n.parts[0], s, i, r.sourceSpan)), this._advance();
      }
      _parseExpansionCase() {
        let e = this._advance();
        ...
        for (;;) {
          if (
            ...
            if (Qs(n, 22)) {
              ...
              return (
                this.errors.push(L.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")),
                null
              );
          if (this._peek.type === 24)
            if (Qs(n, 20)) n.pop();
...
`
      ...
      _consumeStartTag(e) {
        ...
        let o = this._peek.sourceSpan.fullStart,
          ...
          f = new Y(i, s, [], u, p, void 0, l),
          d = this._getContainer();
        this._pushContainer(
          f,
          d instanceof Y && this.getTagDefinition(d.name).isClosedByChild(f.name)
        ),
          a
      ...
      _popContainer(e, r, n) {
        ...
        for (let i = this._containerStack.length - 1; i >= 0; i--) {
          ...
          (a instanceof te || (a instanceof Y && !this.getTagDefinition(a.name).closedByParent)) &&
            (s = !0);
        }
        return !1;
      }
      ...
      _consumeBlockOpen(e) {
        ...
        let n = this._peek.sourceSpan.fullStart,
          ...
          a = new te(e.parts[0], r, [], s, e.sourceSpan, i);
        this._pushContainer(a, !1);
      }
      _consumeBlockClose(e) {
        this._popContainer(null, te, e.sourceSpan) ||
          this.errors.push(
            L.create(
              null,
              e.sourceSpan,
      ...
      _consumeIncompleteBlock(e) {
        ...
        let n = this._peek.sourceSpan.fullStart,
          ...
          a = new te(e.parts[0], r, [], s, e.sourceSpan, i);
        this._pushContainer(a, !1),
          this._popContainer(null, te, null),
          this.errors.push(
            L.create(
              e.parts[0],
              s,
      ...
      _consumeLet(e) {
        ...
        let i = s.sourceSpan.fullStart,
          ...
          l = new ft(r, n.parts[0], a, p, n.sourceSpan);
        this._addToParent(l);
      }
      ...
      _getElementFullName(e, r, n) {
        if (
          e === '' &&
          ((e = this.getTagDefinition(r).implicitNamespacePrefix || ''), e === '' && n != null)
        ) {
          let s = ct(n.name)[1];
...
...`,
  ...
  var ar = { attrs: !0, children: !0, cases: !0, expression: !0 },
    ...
    ze = class ze {
      constructor(e = {}) {
        ...
        cr(this, 'type');
        cr(this, 'parent');
        for (let r of new Set([...ei, ...Object.keys(e)])) this.setProperty(r, e[r]);
      }
      setProperty(e, r) {
        if (this[e] !== r) {
          if ((e in ar && (r = r.map(n => this.createChild(n))), !ei.has(e))) {
            this[e] = r;
            return;
          }
      ...
      map(e) {
        ...
        for (let n in ar) {
          let s = this[n];
          if (s) {
            let i = Po(s, a => a.map(e));
            r !== s && (r || (r = new ze({ parent: this.parent })), r.setProperty(n, i));
          }
        }
      ...
      createChild(e) {
        let r = e instanceof ze ? e.clone() : new ze(e);
  ...
  var Io = [
    { regex: /^(\[if([^\]]*)\]>)(.*?)<!\s*\[endif\]$/su, parse: Ro },
    { regex: /^\[if([^\]]*)\]><!$/u, parse: $o },
    { regex: /^<!\s*\[endif\]$/u, parse: Oo },
  ];
  function ti(t, e) {
    if (t.value)
      for (let { regex: r, parse: n } of Io) {
  ...
  function si(t, e, r) {
    let {
      ...
      { rootNodes: l, errors: f } = Xr(t, {
        canSelfClose: s,
        allowHtmComponentClosingTags: o,
        isTagNameCaseSensitive: u,
        getTagContentType: p ? (...c) => (p(...c) ? P.RAW_TEXT : void 0) : void 0,
    ...
    if (n === 'vue') {
      ...
      let g,
        ...
        q = x =>
          y().rootNodes.find(
            ({ startSourceSpan: U }) => U && U.start.offset === x.startSourceSpan.start.offset
          ) ?? x;
      for (let [x, U] of l.entries()) {
        let { endSourceSpan: tn, startSourceSpan: oi } = U;
        if (tn === null) (f = y().errors), (l[x] = q(U));
        else if (Vo(U, r)) {
          let rn = y().errors.find(
            nn => nn.span.start.offset > oi.start.offset && nn.span.start.offset < tn.end.offset
          );
          rn && ni(rn), (l[x] = q(U));
        }
      }
    ...
    let d = c => {
      ...
      D = c => {
        if (
          c.type === 'element' &&
          (i &&
            (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || fe(c)) &&
            (c.name = A(c.name, g => ri.has(g))),
          a)
        )
          for (let g of c.attrs)
            g.namespace ||
  ...
  function ii(t, e, r = {}, n = !0) {
    let { frontMatter: s, content: i } = n ? Zs(t) : { frontMatter: null, content: t },
      a = new De(t, r.filepath),
      o = new ie(a, 0, 0, 0),
      u = o.moveBy(t.length),
      p = { type: 'root', sourceSpan: new h(o, u), children: si(i, e, r) };
    if (s) {
      let d = new ie(a, 0, 0, 0),
    ...
    zo = lr({
      ...
      shouldParseAsRawText(t, e, r, n) {
        return (
          ...
          (t !== 'template' ||
            n.some(
              ({ name: s, value: i }) => s === 'lang' && i !== 'html' && i !== '' && i !== void 0
            ))
        );
      },
    }),
    Go = lr({ name: 'lwc', canSelfClose: !1 });
  var Yo = { html: bs };
  return fi(jo);
});
