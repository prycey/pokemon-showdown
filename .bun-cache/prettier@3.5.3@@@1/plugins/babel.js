    ...
    Et = (a, t, e, s) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let i of _s(t))
          !js.call(a, i) &&
            i !== e &&
            be(a, i, { get: () => t[i], enumerable: !(s = Rs(t, i)) || s.enumerable });
      return a;
    };
  var It = (a, t, e) => (
      (e = a != null ? Bs(Us(a)) : {}),
      Et(t || !a || !a.__esModule ? be(e, 'default', { value: a, enumerable: !0 }) : e, a)
    ),
    Vs = a => Et(be({}, '__esModule', { value: !0 }), a);
  var gt = $s(me => {
    'use strict';
    ...
    var Nt = 'BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED',
      ...
      we = a => (a.type === 'UpdateExpression' ? kt.UpdateExpression[`${a.prefix}`] : kt[a.type]),
      Hs = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
        ...
        InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${we(a)}.`,
        InvalidLhsBinding: ({ ancestor: a }) => `Binding invalid left-hand side in ${we(a)}.`,
        InvalidLhsOptionalChaining: ({ ancestor: a }) =>
          `Invalid optional chaining in the left-hand side of ${we(a)}.`,
      ...
      Xs = Object.assign(
        {
          ...
          PipeUnparenthesizedBody: ({ type: a }) =>
            `Hack-style pipe body cannot be an unparenthesized ${we({ type: a })}; please wrap it in parentheses.`,
        },
        {
          PipelineBodyNoArrow:
        ...
        readWord1(t) {
          ...
          for (
            ...
            if (Y(r)) this.state.pos += r <= 65535 ? 1 : 2;
              ...
              h !== null &&
                (o(h) || this.raise(p.EscapedCharNotAnIdentifier, n),
      ...
      $i = a =>
        class extends a {
          ...
          flowParseDeclareClass(e) {
            return (
              this.next(), this.flowParseInterfaceish(e, !0), this.finishNode(e, 'DeclareClass')
            );
          }
            ...
            if (((i = n) != null && i.error) || this.match(47)) {
              ...
              if (
                ...
                if (!c.error && !c.aborted)
                  return (
                    c.node.async &&
                      this.raise(g.UnexpectedTypeParameterBeforeAsyncArrowFunction, l),
                    c.node
                  );
                u = c.node;
              }
          ...
          flowEnumMembers({ enumName: e, explicitType: s }) {
            ...
            for (; !this.match(8); ) {
              ...
              /^[a-z]/.test(c) &&
                ...
                i.has(c) &&
                  this.raise(g.EnumDuplicateMemberName, h, { memberName: c, enumName: e }),
                i.add(c);
      ...
      class extends a {
        ...
        tsParseModifiers(
          ...
          let o = (l, c, u, f) => {
              c === u &&
                n[f] &&
                this.raise(y.InvalidModifiersOrder, l, { orderedModifiers: [u, f] });
            },
            h = (l, c, u, f) => {
              ((n[u] && c === f) || (n[f] && c === u)) &&
    ...
    var is = { estree: ti, jsx: zi, flow: $i, typescript: Hi, v8intrinsic: Yi, placeholders: Gi },
      ...
      ot = class extends nt {
        ...
        parseAsyncArrowUnaryFunction(t) {
          this.prodParam.enter(Ee(!0, this.prodParam.hasYield));
          let e = [this.parseIdentifier()];
          return (
            this.prodParam.exit(),
            this.hasPrecedingLineBreak() &&
        ...
        parsePrivateName() {
          let t = this.startNode(),
            ...
            s = this.state.value;
          return (
            this.next(), (t.id = this.createIdentifier(e, s)), this.finishNode(t, 'PrivateName')
          );
        }
...
`
        ...
        parseMethod(t, e, s, i, r, n, o = !1) {
          this.initFunction(t, s),
            ...
            this.prodParam.enter(Ee(s, t.generator)),
        ...
        parseArrowExpression(t, e, s, i) {
          ...
          return (
            e &&
              ((this.state.maybeInArrowParameters = !0), this.setArrowFunctionParameters(t, e, i)),
    ...
    var ht = class extends ot {
        ...
        parseFunction(t, e = 0) {
          ...
          return (
            (this.state.maybeInArrowParameters = !1),
            this.scope.enter(2),
            this.prodParam.enter(Ee(n, t.generator)),
          ...
          if (
            ...
            this.withSmartMixTopicForbiddingContext(() => {
              for (; !this.match(8); ) {
                ...
                let n = this.startNode();
                i.length &&
                  ((n.decorators = i), this.resetStartLocationFromNode(n, i[0]), (i = [])),
        ...
        maybeParseDefaultImportSpecifier(t, e) {
          if (e) {
            ...
            return (
              this.parseImportSpecifierLocal(t, this.startNode(), 'ImportDefaultSpecifier'), !0
            );
          return !1;
        }
...
`);
  ...
  function Cr(a) {
    ...
    return (
      ...
      Oe(t, { loc: { start: { line: e, column: s + 1 } }, cause: r })
    );
  }
  var Fe = Cr;
  var Er = (a, t, e, s) => {
  ...
  function zr({ isExpression: a = !1, optionsCombinations: t }) {
    return (e, s = {}) => {
      ...
      e.includes('|>')
        ...
        : n && (i = i.map(l => $([ws], l)));
      let o = a ? Re.parseExpression : Re.parse,
        h;
      try {
      ...
      return (
        a && (h = Be(h, { text: e, rootMarker: s.rootMarker })), xs(h, { parser: 'babel', text: e })
      );
    };
  }
  var Vr = new Set([
