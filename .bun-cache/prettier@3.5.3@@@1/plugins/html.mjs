...
var li = (t, e, r) =>
  e in t ? sn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r);
var on = (t, e) => {
  for (var r in e) sn(t, r, { get: e[r], enumerable: !0 });
};
var lr = (t, e, r) => li(t, typeof e != 'symbol' ? e + '' : e, r),
  un = (t, e, r) => e.has(t) || an('Cannot ' + r);
var R = (t, e, r) => (un(t, e, 'read from private field'), r ? r.call(t) : e.get(t)),
  Et = (t, e, r) =>
    e.has(t)
      ...
      : e instanceof WeakSet
        ? e.add(t)
        : e.set(t, r),
  ln = (t, e, r, n) => (un(t, e, 'write to private field'), n ? n.call(t, r) : e.set(t, r), r);
var en = {};
...
var Le = hi;
var fi = t => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(t);
function mi(t) {
  ...
  function s(i) {
    switch (Le(i)) {
      ...
      case Te: {
        ...
        return (
          a ? ((a = a.map(n)), (o = a[0])) : (o = n(o)), e({ ...i, contents: o, expandedStates: a })
        );
      }
      case be:
      case we:
...
function E(t, e = {}) {
  return (
    ne(t),
    mr(e.expandedStates, !0),
    { type: Te, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates }
  );
}
function fn(t) {
  return hn(Number.NEGATIVE_INFINITY, t);
}
function mn(t) {
  return hn({ type: 'root' }, t);
}
function Dt(t) {
  return pn(t), { type: xe, parts: t };
}
function pe(t, e = '', r = {}) {
  return (
...
var se = { type: Be };
var gi = { type: j, hard: !0 },
  Ci = { type: j, hard: !0, literal: !0 },
  _ = { type: j },
  v = { type: j, soft: !0 },
  S = [gi, se],
  cn = [Ci, se];
...
function En(t, e) {
  var r;
  if (t.type === 'text' || t.type === 'comment' || Fe(t) || t.type === 'yaml' || t.type === 'toml')
    return null;
  if (
    ...
    for (let n of e.parameters.children)
      vi.has(t.name) ? delete n.expression : (n.expression = n.expression.trim());
...
async function yi(t, e) {
  if (t.language === 'yaml') {
    ...
    return mn([t.startDelimiter, t.explicitLanguage, S, n, n ? S : '', t.endDelimiter]);
  }
}
var Dn = yi;
function he(t, e = !0) {
...
function wi(t, e, r, n) {
  ...
  return /^\s*$/u.test(i) ? '' : T(i, t, { parser: '__ng_directive', __isInHtmlAttribute: !1 }, Q);
}
var vn = wi;
...
function xi(t, e) {
  let r = t.plugins.flatMap(s => s.languages ?? []),
    n = Ti(r, e.language) ?? yn(r, e.physicalFile) ?? yn(r, e.file) ?? (e.physicalFile, void 0);
...
function yt(t, e) {
  return !!(
    ...
    (Tt(t, e) && !W(t) && t.type !== 'interpolation')
  );
}
function de(t) {
  return t.type === 'attribute' || !t.parent || !t.prev ? !1 : Li(t.prev);
}
function Li(t) {
...
function Ln(t) {
  return W(t) || t.type === 'interpolation' || _r(t);
}
function _r(t) {
  return Vn(t).startsWith('pre');
}
function Fn(t, e) {
  var s, i;
  let r = n();
            ...
            : !(
                (!t.prev &&
                  (t.parent.type === 'root' ||
                    ...
                    W(t.parent) ||
                    et(t.parent, e) ||
                    !$i(t.parent.cssDisplay))) ||
                (t.prev && !qi(t.prev.cssDisplay))
              );
  }
}
function Nn(t, e) {
          ...
          : !(
              (!t.next &&
                (t.parent.type === 'root' ||
                  ...
                  W(t.parent) ||
                  et(t.parent, e) ||
                  !Oi(t.parent.cssDisplay))) ||
              (t.next && !Mi(t.next.cssDisplay))
            );
}
function Pn(t) {
  return Hi(t.cssDisplay) && !W(t);
}
function Je(t) {
  return (
    Fe(t) ||
...
function In(t) {
  return (
    ...
    (t.type === 'element' &&
      t.children.length > 0 &&
      (['body', 'script', 'style'].includes(t.name) || t.children.some(e => Ni(e)))) ||
    (t.firstChild &&
      t.firstChild === t.lastChild &&
      t.firstChild.type !== 'text' &&
      $n(t.firstChild) &&
      (!t.lastChild.isTrailingSpaceSensitive || On(t.lastChild)))
  );
}
function Er(t) {
  return (
...
function wt(t) {
  return Mn(t) || (t.prev && Fi(t.prev)) || Rn(t);
}
function Fi(t) {
  return Mn(t) || (t.type === 'element' && t.fullName === 'br') || Rn(t);
}
function Rn(t) {
  return $n(t) && On(t);
}
...
function Hn(t, e) {
  ...
  if (t.type === 'element' && t.namespace === 'svg')
    if (Vi(t, s => s.fullName === 'svg:foreignObject')) r = !0;
  ...
  switch (e.htmlWhitespaceSensitivity) {
    ...
    case 'ignore':
      return 'block';
    default:
      return (t.type === 'element' && (!t.namespace || r || fe(t)) && bn[t.name]) || wn;
  }
}
function Vn(t) {
  return (t.type === 'element' && (!t.namespace || fe(t)) && xn[t.name]) || Tn;
}
function Ui(t) {
...
var Wi = new Set(['template', 'style', 'script']);
function et(t, e) {
  return ge(t, e) && !Wi.has(t.fullName);
}
function ge(t, e) {
  return (
    e.parser === 'vue' &&
...
async function zn(t, e) {
  let r = [];
  for (let [n, s] of t.split(yr).entries())
    if (n % 2 === 0) r.push(B(s));
    else
      try {
        r.push(
  ...
  function f() {
    for (p(Qi), s = '', i = 'in descriptor'; ; ) {
      if (((a = t.charAt(o)), i === 'in descriptor'))
        if (jn(a)) s && (n.push(s), (s = ''), (i = 'after descriptor'));
        else if (a === ',') {
          (o += 1), s && n.push(s), d();
          return;
...
function sa(t) {
  let e = Qn(t),
    r = na.filter(l => e.some(f => Object.prototype.hasOwnProperty.call(f, l)));
...
function ia(t, e) {
  ...
  return (
    br.has(r) ||
      br.set(
        r,
        r.children.some(n => kt(n, e) && ['ts', 'typescript'].includes(n.attrMap.lang))
      ),
    br.get(r)
  );
}
...
function ts(t, e, { parseWithTs: r }) {
  return T(`function _(${t}) {}`, e, { parser: r ? 'babel-ts' : 'babel', __isVueBindings: !0 });
}
async function rs(t, e, r, n) {
  let s = N(r.node),
    { left: i, operator: a, right: o } = aa(s),
    u = Pe(r, n);
  return [
    E(
...
async function ua(t, e, { parseWithTs: r }) {
  var n;
  try {
    return await ns(t, e, { parseWithTs: r });
  } catch (s) {
...
function tt(t, e) {
  return [t.isSelfClosing ? '' : fa(t, e), Ce(t, e)];
}
function fa(t, e) {
  return t.lastChild && Ee(t.lastChild) ? '' : [ma(t, e), Bt(t, e)];
}
function Ce(t, e) {
...
function z(t, e) {
  return Ee(t) ? Bt(t.parent, e) : rt(t) ? Lt(t.next, e) : '';
}
function Bt(t, e) {
  if ((Tr.ok(!t.isSelfClosing), us(t, e))) return '';
  switch (t.type) {
    case 'ieConditionalComment':
      return '<!';
    case 'element':
...
function us(t, e) {
  return !t.isSelfClosing && !t.endSourceSpan && (de(t) || yt(t.parent, e));
}
function X(t) {
  return (
    t.prev &&
...
function Ee(t) {
  return !t.next && !t.hasTrailingSpaces && t.isTrailingSpaceSensitive && $(bt(t));
}
function rt(t) {
...
function ga(t, e, r) {
  ...
  let s = ((f = n.prev) == null ? void 0 : f.type) === 'comment' && da(n.prev.value),
...
function Ca(t) {
  return t.firstChild && nt(t.firstChild) ? '' : Ft(t);
}
function st(t, e, r) {
  let { node: n } = t;
  return [Ae(n, e), ga(t, e, r), n.isSelfClosing ? '' : Ca(n)];
}
function Ae(t, e) {
  return t.prev && rt(t.prev) ? '' : [G(t, e), Lt(t, e)];
}
function G(t, e) {
  return nt(t) ? Ft(t.parent) : X(t) ? Se(t.prev, e) : '';
}
var os = '<!doctype';
function Lt(t, e) {
  switch (t.type) {
    ...
    case 'docType': {
      ...
      return e.originalText.slice(J(t), Z(t)).slice(0, os.length);
    }
    case 'angularIcuExpression':
      return '{';
    case 'element':
...
function Ft(t) {
  switch ((Tr.ok(!t.isSelfClosing), t.type)) {
    case 'ieConditionalComment':
      return ']>';
    case 'element':
...
function Sa(t, e) {
  ...
  t.firstChild && nt(t.firstChild) && (r -= Ft(t).length);
...
var Nt = Sa;
var _a = new Set(['if', 'else if', 'for', 'switch', 'case']);
function Ea(t, e) {
  let { node: r } = t;
  switch (r.type) {
    case 'element':
        ...
        return n
          ? async (s, i) => {
              let a = Nt(r, e),
                ...
                u = '';
              return (
                o || ((u = await s(Sr(a), { parser: n, __embeddedInHtml: !0 })), (o = u === '')),
    ...
    case 'angularControlFlowBlockParameters':
      return _a.has(t.parent.name) ? vn : void 0;
...
var Aa = 10;
for (let t = 0; t <= Aa; t++) at();
function xr(t) {
  return at(t);
}
function Da(t, e = 'type') {
  xr(t);
  function r(n) {
    let s = n[e],
      i = t[s];
...
function gs(t) {
  ...
  return t.type === 'element' && !t.endSourceSpan && Ie(t.children)
    ? Math.max(e, gs(K(!1, t.children, -1)))
    : e;
}
function ot(t, e, r) {
  let n = t.node;
      ...
      B(
        O.trimEnd(
          e.originalText.slice(
            J(n) + (n.prev && rt(n.prev) ? Lt(n).length : 0),
...
function Ds(t, e, r) {
  let { node: n } = t;
  if (yt(n, e)) return [G(n, e), E(st(t, e, r)), B(Nt(n, e)), ...tt(n, e), z(n, e)];
  let s =
      n.children.length === 1 &&
  ...
  t.walk(e => {
    ...
    if (!n)
      for (let i = 0; i < r.length; i++) {
        ...
        let { leadingWhitespace: o, text: u, trailingWhitespace: p } = kn(a.value),
          l = a.prev,
          f = a.next;
        u
          ? ((a.value = u),
...
function Ir() {
  return (
    qt ||
      ((qt = {}),
      Mt(ee.HTML, ['iframe|srcdoc', '*|innerHTML', '*|outerHTML']),
      Mt(ee.STYLE, ['*|style']),
      Mt(ee.URL, [
        '*|formAction',
        'area|href',
...
var Ua = 'boolean',
  ...
  ja = Array.from(Is).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
  Vt = class extends Ht {
    constructor() {
      super(),
    ...
    hasProperty(e, r, n) {
      ...
      if (e.indexOf('-') > -1) {
        if (Nr(e) || Pr(e)) return !1;
        if (n.some(i => i.name === Lr.name)) return !0;
      }
      return (this._schema.get(e.toLowerCase()) || this._schema.get('unknown')).has(r);
    }
    hasElement(e, r) {
      return r.some(n => n.name === Fr.name) ||
        (e.indexOf('-') > -1 && (Nr(e) || Pr(e) || r.some(n => n.name === Lr.name)))
        ? !0
...
var Rr = class t {
    static fromArray(e) {
      return e ? ($s('interpolation', e), new t(e[0], e[1])) : $r;
    }
    constructor(e, r) {
  ...
  Ur = class {
    constructor(e, r, n) {
      (this._getTagContentType = r),
        ...
        (this._interpolationConfig = n.interpolationConfig || $r),
      ...
      (this._cursor = n.escapedString ? new Wr(e, s) : new rr(e, s)),
...
`
    ...
    _getBlockName() {
      ...
      return (
        this._attemptCharCodeUntilFn(n => (ut(n) ? !e : zs(n) ? ((e = !0), !1) : !0)),
    ...
    _consumeBlockParameters() {
      for (
        this._attemptCharCodeUntilFn(Gs);
    ...
    _attemptCharCodeCaseInsensitive(e) {
      return yo(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
    }
    _requireCharCode(e) {
      let r = this._cursor.clone();
    ...
    _consumePrefixAndName() {
      ...
      this._cursor.peek() === 58
        ...
        : (n = e),
        this._requireCharCodeUntilFn(Us, r === '' ? 0 : 1);
      let s = this._cursor.getChars(n);
      return [r, s];
    }
    _consumeTagOpen(e) {
    ...
    _isBlockStart() {
      if (this._tokenizeBlocks && this._cursor.peek() === 64) {
        let e = this._cursor.clone();
        if ((e.advance(), zs(e.peek()))) return !0;
      }
      return !1;
    }
    _readUntil(e) {
...
var ir = { attrs: !0, children: !0, cases: !0, expression: !0 },
  ...
  ze = class ze {
    constructor(e = {}) {
      ...
      lr(this, 'type');
      lr(this, 'parent');
      for (let r of new Set([...ti, ...Object.keys(e)])) this.setProperty(r, e[r]);
    }
    setProperty(e, r) {
      if (this[e] !== r) {
...
var Lo = [
  { regex: /^(\[if([^\]]*)\]>)(.*?)<!\s*\[endif\]$/su, parse: Fo },
  { regex: /^\[if([^\]]*)\]><!$/u, parse: No },
  { regex: /^<!\s*\[endif\]$/u, parse: Po },
];
function ri(t, e) {
  if (t.value)
    ...
    for (let [x, U] of l.entries()) {
      ...
      if (tn === null) (f = y().errors), (l[x] = q(U));
        ...
        let rn = y().errors.find(
          nn => nn.span.start.offset > ui.start.offset && nn.span.start.offset < tn.end.offset
        );
        rn && si(rn), (l[x] = q(U));
      }
    }
      ...
      if (
        ...
        for (let g of c.attrs)
          g.namespace ||
            (g.name = A(
              g.name,
              y => or.has(c.name) && (or.get('*').has(y) || or.get(c.name).has(y))
            ));
    },
    I = c => {
      c.sourceSpan &&
...
function ai(t, e, r = {}, n = !0) {
  let { frontMatter: s, content: i } = n ? ei(t) : { frontMatter: null, content: t },
    a = new De(t, r.filepath),
    o = new ie(a, 0, 0, 0),
    u = o.moveBy(t.length),
    p = { type: 'root', sourceSpan: new h(o, u), children: ii(i, e, r) };
  if (s) {
...
function ur(t) {
  return { parse: (e, r) => ai(e, t, r), hasPragma: fs, astFormat: 'html', locStart: J, locEnd: Z };
}
var oi = {
    name: 'html',
    normalizeTagName: !0,
