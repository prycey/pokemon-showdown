  ...
  dl = (e, r, t, n) => {
    if ((r && typeof r == 'object') || typeof r == 'function')
      for (let a of Dl(r))
        !hl.call(e, a) &&
          a !== t &&
          Dt(e, a, { get: () => r[a], enumerable: !(n = fl(r, a)) || n.enumerable });
    return e;
  };
var Ue = (e, r, t) => (
  (t = e != null ? ll(pl(e)) : {}),
  dl(r || !e || !e.__esModule ? Dt(t, 'default', { value: e, enumerable: !0 }) : t, e)
);
          ...
          for (R = g.slice(O, S), L = b.now(), ee = 0, Z = 0, ve = T, Ee = []; T < k; ) {
            if (((_ = g.charCodeAt(T)), _ !== _ || _ === Ur))
              (M = { start: ee, contentStart: ve || T, contentEnd: T, end: T }),
                Ee.push(M),
                _ === Ur && ((ee = T + 1), (Z = 0), (ve = void 0), (M.end = ee));
            else if (Z !== void 0)
              if (_ === je || _ === Dr)
        ...
        if (O !== void 0)
          return A
            ...
            : ((T = b.now()),
              (T.column += 2),
              (T.offset += 2),
              b(g.slice(0, x))({ type: 'footnote', children: w.tokenizeInline(g.slice(R, O), T) }));
      }
    }
    function F(b, g, A) {
      var w = 0;
  ...
  function th(e, r, t) {
    ...
    return (
      ...
      e.options.gfm &&
        ((i = r.match(Xp)),
        i &&
          ((o = i[0].length), (u = i[1].toLowerCase() === Kp), (n[t.line] += o), (r = r.slice(o)))),
...
`,
  ...
  function ud(e, r, t) {
    ...
    if (n.options.gfm) {
      ...
      for (
        o = c.join(et), u = c.splice(1, 1)[0] || [], a = 0, l = u.length, E--, i = !1, D = [];
        a < l;
        ...
        if (((c = r.charAt(i)), !(!o || c !== fn)))
          return t
            ...
            : ((l += o),
              ...
              D(),
              e(a)({ type: 'link', title: null, url: md(l, { nonTerminated: !1 }), children: p }));
      }
    }
  }
});
...
var es = C((PE, Zo) => {
  ...
  function Qo(e, r, t) {
    ...
    if (
      !(r.charAt(0) !== Kd || a < 3) &&
      ((u = r.charAt(1)), !(!$d(u) && u !== Jd && u !== Xd && u !== Qd) && ((i = r.match(Hd)), !!i))
    )
      return t
        ? !0
        : ((i = i[0]),
...
var $c = C((DC, jc) => {
  ...
  function Vc() {
    ...
    function s(m) {
      ...
      function b(g, A) {
        var w = l(g);
        w ? (Uc(w[1]) && Uc(A) && (A = lt(!0, w[1], A)), (w[1] = A)) : e.push(bm.call(arguments));
      }
    }
    function l(m) {
  ...
  function a(u) {
    switch (Y(u)) {
      ...
      case J: {
        ...
        return (
          i ? ((i = i.map(n)), (o = i[0])) : (o = n(o)), r({ ...u, contents: o, expandedStates: i })
        );
      }
      case te:
      case re:
...
function lf(e, r, t) {
  ...
  if (mf(e)) {
    let i = [''],
      o = Pr(r.originalText.slice(n.position.start.offset, n.position.end.offset));
    for (let s of o) {
      if (s.type === 'word') {
...
`,
    ...
    case 'definition': {
      ...
      return Me([Tt(n), ':', nr([i, Bt(n.url), n.title === null ? '' : [i, Rr(n.title, r, !1)]])]);
    }
    case 'footnote':
      return ['[^', $(e, r, t), ']'];
      ...
      return [
        ...
        i
          ...
          : Me([
              ye(
                ' '.repeat(4),
                $(e, r, t, { processor: ({ isFirst: o }) => (o ? Me([_r, t()]) : t()) })
              ),
            ]),
      ];
    }
...
function $(e, r, t, n = {}) {
  ...
  return (
    e.each(() => {
      let i = a(e);
      i !== !1 &&
        (u.length > 0 && hf(e) && (u.push(P), (df(e, r) || Ni(e)) && u.push(P), Ni(e) && u.push(P)),
        u.push(i));
    }, 'children'),
    u
  );
...
function df({ node: e, previous: r, parent: t }, n) {
  ...
  let i = r.type === e.type && cf.has(e.type),
    ...
    s = qt(r) === 'next',
    l = e.type === 'html' && r.type === 'html' && r.position.end.line + 1 === e.position.start.line,
    c =
      e.type === 'html' &&
      t.type === 'listItem' &&
      r.type === 'paragraph' &&
...
function Rr(e, r, t = !0) {
  ...
  if (((e = N(!1, e, /\\(?=["')])/gu, '')), e.includes('"') && e.includes("'") && !e.includes(')')))
    return `(${e})`;
...
function Lm() {
  return e =>
    Ae(e, (r, t, [n]) =>
      r.type !== 'html' || Hc.test(r.value) || Lr.has(n.type) ? r : { ...r, type: 'jsx' }
    );
}
var el = Lm;
var Pm = function () {
...
var Um = { mdast: Mi };
var OC = zn;
export { OC as default, zi as languages, Yi as options, Mn as parsers, Um as printers };
