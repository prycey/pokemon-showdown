    ...
    pr = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let u of Bu(t))
          !_u.call(e, u) &&
            u !== r &&
            Me(e, u, { get: () => t[u], enumerable: !(n = vu(t, u)) || n.enumerable });
      return e;
    };
  var Ve = (e, t, r) => (
      (r = e != null ? Au(wu(e)) : {}),
      pr(t || !e || !e.__esModule ? Me(r, 'default', { value: e, enumerable: !0 }) : r, e)
    ),
    xu = e => pr(Me({}, '__esModule', { value: !0 }), e);
  var bu = (e, t, r) => t.has(e) || fr('Cannot ' + r);
  var Fr = (e, t, r) =>
    t.has(e)
      ? fr('Cannot add the same private member more than once')
...
${f}`),
  ...
  var ze =
    ...
    Su = new RegExp('['.concat(ze, ']+|\\s+|[^').concat(ze, ']'), 'ug'),
    Ke = new U();
...
`
  ...
  var $ = 'string',
    ...
    O = 'label',
    _ = 'break-parent',
    Je = new Set([z, T, k, L, B, N, w, P, I, R, y, O, _]);
  var Pu = (e, t, r) => {
      if (!(e && t == null))
      ...
      switch (M(i)) {
        ...
        case B: {
          ...
          return (
            ...
            t({ ...i, contents: s, expandedStates: o })
          );
        }
        case k:
        case T:
...
`)
  ...
  function Yr(e, t = '', r = {}) {
    return (
      G(e), t !== '' && G(t), { type: w, breakContents: e, flatContents: t, groupId: r.groupId }
    );
  }
  function jr(e, t) {
  ...
  function Vr(e) {
    ...
    function n(i, o, s) {
      ...
      if (i.type === _)
        return ((D = s == null ? void 0 : s[o - 1]) == null ? void 0 : D.type) === y &&
          s[o - 1].hard
          ? void 0
          : 'breakParent';
...
`,
        ...
        case N: {
          ...
          let $e = h[m + 2],
            At = { ind: f, mode: d, doc: { ...c, [Pt]: m + 2 } };
          tt({ ind: f, mode: J, doc: [v, E, $e] }, [], F, D.length > 0, r, !0)
            ? o.push(At, X, g)
            : b
              ? o.push(At, ae, g)
              : o.push(At, ae, j);
...
` ||
  ...
  function on(e, t) {
    ...
    for (let [d, c] of f.entries()) {
      ...
      if (
        ...
        (F.placement = 'ownLine'),
          D(...b) || (C ? ue(C, F) : m ? ie(m, F) : h ? re(h, F) : re(g, F));
      else if (ui(v, E, f, d))
  ...
  function nn(e, t) {
    ...
    for (let D of [n, u])
      D.comments &&
        D.comments.length > 1 &&
        D.comments.sort((l, p) => t.locStart(l) - t.locStart(p));
    e.length = 0;
  }
  function Vt(e, t, r) {
  ...
  function oi(e, t) {
    ...
    if ((l = u.isBlockComment) == null ? void 0 : l.call(u, r)) {
      let p = V(i, s(r)) ? (V(i, o(r), { backwards: !0 }) ? K : Ze) : ' ';
      n.push(p);
    } else n.push(K);
    let D = W(i, S(i, s(r)));
  ...
  function yi(e, { isCLI: t, FlagSchema: r }) {
    ...
    for (let u of e)
      n.push(Ai(u, { isCLI: t, optionInfos: e, FlagSchema: r })),
        u.alias && t && n.push(lt.create({ name: u.alias, sourceName: u.name }));
    return n;
  }
