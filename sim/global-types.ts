...
interface ModdedBattleActions {
  ...
  canDynamax?: (
    ...
    pokemon: Pokemon,
    skipChecks?: boolean
  ) => import('./side').DynamaxOptions | void;
  forceSwitch?: (
    this: BattleActions,
  ...
  getFormeChangeDeltas?: (
    this: BattleActions,
    formeChangeSpecies: Species,
    pokemon?: Pokemon
  ) => AnyObject;
  getMixedSpecies?: (
    this: BattleActions,
